...
! function (e) {
  ...
  var r = n(7),
    ...
    G = function (e) {
      ...
      return (0, l["default"])(t, e), t.prototype.addListener = function (t, n) {
        ...
        var e = {};
        return e.controls = [], _["default"].each(this.getControlById(), function (t) {
          e.controls.push({
            id: t.getCtrlElement().getAttribute("id"),
            type: t.TYPE_NAME,
            value: t.getValue()
          })
        }), e.html = encodeURIComponent(this.html()), '<?xml version="1.0" encoding="UTF-8"?>' + (new E["default"]).js2xml({
          xml: e
        })
  ...
  e.exports = {
    ...
    changeSTRICT: function (e) {
      ...
      var n = e[r.__private__].rootDom.querySelectorAll("[krcd-contenteditable]");
      s["default"].each(n, function (e) {
        e.setAttribute("contenteditable", e.setAttribute("krcd-contenteditable")), e.removeAttribute("krcd-contenteditable")
      })
    },
