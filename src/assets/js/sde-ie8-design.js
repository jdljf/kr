...
! function (e) {
  ...
  var i = n(2),
    ...
    d = function (e, t, n) {
      e.innerHTML = "", a["default"].each(t, function (t) {
  ...
  e.exports = {
    getTValue: function (e) {
      var t = o["default"].filterNodeList(e.selection.getStartElementPath(), "p h1 h2 h3 h4 h5 h6");
      return t && t.style.marginLeft && Math.round(parseInt(t.style.marginLeft) / 32)
    },
    getSelectBtn: function (e, t, n, r, i) {
      function A(e) {
        u || (g.innerHTML = e.title), g.setAttribute("name", e.name), g.setAttribute("title", e.title)
      }
      var u = arguments.length > 5 && arguments[5] !== undefined && arguments[5],
        ...
        g = o["default"].createElement(document, "div", {
          "class": u ? "krcd-icon krcd-icon-" + t.name + " editor-paragraphs-icon" : "ctrl-content-btn0-body",
          style: e ? "width:" + e + "px" : ""
        }),
        m = o["default"].createElement(document, "div", {
          "class": "krcd-icon krcd-icon-down"
        }),
      ...
      d(h, t.items, r), b.appendChild(v), b.appendChild(h), a["default"].registerEvent(m, "click", function () {
        ...
        b.style.display = "", A(c), a["default"].each(t.items, function (e) {
          e.selected = e.name === c.name
        }), d(h, t.items, r), i && i(f, c)
      }), f.addListener("selectionchange", function (e, t, r) {
        r || (n(f, function (e) {
          A(e)
        }) ? o["default"].removeClasses(p, "ctrl-disabled") : o["default"].addClass(p, "ctrl-disabled"))
      });
      var w = c(t.items);
      return w && A(w), p.appendChild(g), p.appendChild(m), p.appendChild(b), p
    },
    getSelectBigBtn: function (e, t, n, r) {
      function i() {
        ...
        if (t) {
          var r = o["default"].findParent(t, function (e) {
            return "TABLE" === e.nodeName
          }, !0);
          r ? a["default"].each(e.items, function (e) {
      ...
      var A = this,
        ...
        f = o["default"].createElement(document, "div", {
          "class": "krcd-icon krcd-icon-" + e.name,
      ...
      d(b, e.items, n), g.appendChild(m), g.appendChild(b), a["default"].registerEvent(f, "click", function () {
        i()
        ...
        g.style.display = "", a["default"].each(e.items, function (e) {
          e.selected = e.name === A.name
        }), r && r(u, A)
      }), u.addListener("selectionchange", function (e, n, r) {
        r || (t(u, function (e) {}) ? o["default"].removeClasses(s, "ctrl-disabled") : o["default"].addClass(s, "ctrl-disabled"))
      });
      c(e.items);
    ...
    getSelectBtnNoBorder: function (e, t, n, r) {
      function i(e) {
        d || (f.innerHTML = e.title), f.setAttribute("name", e.name), f.setAttribute("title", e.title)
      }
      var A = this,
        d = !0,
        u = A[l.__private__].ue,
        ...
        f = o["default"].createElement(document, "div", {
          "class": d ? "krcd-icon krcd-icon-" + e.name + " editor-paragraphs-icon" : "ctrl-content-btn0-body",
          style: ""
        }),
        p = o["default"].createElement(document, "div", {
          "class": "krcd-icon krcd-icon-down",
      ...
      v.appendChild(function () {
        ...
        r || (t(u, function (e) {
          i(e)
        }) ? o["default"].removeClasses(s, "ctrl-disabled") : o["default"].addClass(s, "ctrl-disabled"))
      });
      var C = c(e.items);
      return C && i(C), s.appendChild(f), s.appendChild(b), s.appendChild(p), s.appendChild(g), s
    },
    getSmallBtn: function (e, t, n) {
      var r = arguments.length > 3 && arguments[3] !== undefined && arguments[3],
        ...
        A = o["default"].createElement(document, "div", {
          ...
          title: e.title,
          name: e.name,
          style: i ? "border: 1px solid #d3d3d3;border-radius: 2px;margin-right: 4px;padding: 0 2px!important;margin-bottom: 3px;" : ""
        });
      A.appendChild(o["default"].createElement(document, "div", {
        "class": "krcd-icon krcd-icon-" + e.name
      }));
      var c = o["default"].createElement(document, "div", {
        style: "text-align: center;float:left;margin-top: 3px;" + (i ? "line-height:22px;" : "") + (r ? "" : "padding-right: 5px;")
      });
      r || (c.innerHTML = e.title), A.appendChild(c);
      var d = this,
        u = d[l.__private__].ue;
      return u.addListener("selectionchange", function (e, n, r) {
        r || (t(u) ? o["default"].removeClasses(A, "ctrl-disabled") : o["default"].addClass(A, "ctrl-disabled"))
    ...
    getBigBtn: function (e, t, n) {
      ...
      r.appendChild(o["default"].createElement(document, "div", {
        "class": "krcd-icon krcd-icon-" + e.name,
        style: "width: 40px;height: 32px;float: none;"
      }));
      ...
      return c.addListener("selectionchange", function (e, n, i) {
        i || (t(c) ? o["default"].removeClasses(r, "ctrl-disabled") : o["default"].addClass(r, "ctrl-disabled"))
  ...
  c = l.extend, e.exports = c({
    ...
    getUUID: function () {
      var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 8,
        ...
        o = void 0;
      if (t = t || r.length, e)
        for (o = 0; o < e; o++) i[o] = r[0 | Math.random() * t];
      else {
        var A = void 0;
        for (i[8] = i[13] = i[18] = i[23] = "-", i[14] = "4", o = 0; o < 36; o++) i[o] || (A = 0 | 16 * Math.random(), i[o] = r[19 == o ? 3 & A | 8 : A])
      }
  ...
  e.exports = l({
    ...
    findParentValueNode: function (e) {
      return a["default"].findParent(e, function (e) {
        return a["default"].hasClass(e, "krcd-value")
      }, !0)
    },
    findParentCtrlNode: function (e) {
      return a["default"].findParent(e, function (e) {
        return a["default"].hasClass(e, "krcd-ctrl")
      }, !0)
    },
    ...
    setStyleByAttr: function (e, t, n) {
      for (var r = (e.getAttribute("style") || "").trim(";"), i = r.split(";") || [], o = [], A = !1, a = 0, l = i.length; a < l; a++) {
        i[a].split(":")[0].trim() === t ? (n && (i[a] = t + ":" + n, o.push(i[a])), A = !0) : o.push(i[a])
      }!A && n && o.push(t + ":" + n), e.setAttribute("style", o.join(";"))
    },
    regNbsp: /\s/
  ...
  e.exports = {
    ...
    ctrl_krcd: (0, i["default"])("ctrl_krcd"),
  ...
  function w() {
    ...
    for (var t = {}, n = 0, r = arguments.length; n < r; n++) h(arguments[n], e);
    return t
  }
  ...
  e.exports = {
    getDialog: function (e, t, n, r, i, o) {
      return new window.UE.ui.Dialog({
        iframeUrl: window.KRCD_CONFIG.HOME_URL_DIALOGS + n + (window.IKRCDBUGGER ? "?temp=" + (new Date).getTime() : ""),
        name: t,
        editor: e,
        title: r,
        cssRules: i,
    ...
    getUEDialog: function (e, t, n, r, i, o) {
      return new window.UE.ui.Dialog({
        iframeUrl: window.UEDITOR_CONFIG.UEDITOR_HOME_URL + "dialogs/" + n + (window.IKRCDBUGGER ? "?temp=" + (new Date).getTime() : ""),
        name: t,
        editor: e,
        title: r,
        cssRules: i,
        holdScroll: "krcd-insertimage" === t,
  ...
  (function (t) {
    ...
    ! function (t, n) {
      ...
      function m(e, t) {
        t._state === z ? w(e, t._result) : t._state === _ ? B(e, t._result) : C(t, undefined, function (t) {
          return v(e, t)
        }, function (t) {
          return B(e, t)
        })
      ...
      function b(e, t, r) {
        t.constructor === e.constructor && r === l && t.constructor.resolve === c ? m(e, t) : r === ee ? (B(e, ee.error), ee.error = null) : r === undefined ? w(e, t) : n(r) ? g(e, t, r) : w(e, t)
      }
      ...
      function w(e, t) {
        e._state === K && (e._result = t, e._state = z, 0 !== e._subscribers.length && F(E, e))
      }

      function B(e, t) {
        e._state === K && (e._state = _, e._result = t, F(h, e))
      }

      function C(e, t, n, r) {
        var i = e._subscribers,
          o = i.length;
        e._onerror = null, i[o] = t, i[o + z] = n, i[o + _] = r, 0 === o && e._state && F(E, e)
      }
      ...
      function E(e) {
        var t = e._subscribers,
          n = e._state;
        if (0 !== t.length) {
          for (var r = void 0, i = void 0, o = e._result, A = 0; A < t.length; A += 3) r = t[A], i = t[A + n], r ? x(n, r, i, o) : i(o);
      ...
      function x(e, t, r, i) {
        var o = n(r),
          ...
          c = void 0;
        if (o) {
          if (A = y(r, i), A === ee ? (c = !0, a = A.error, A.error = null) : l = !0, t === A) return void B(t, s())
        } else A = i, l = !0;
        t._state !== K || (o && l ? v(t, A) : c ? B(t, a) : e === z ? w(t, A) : e === _ && B(t, A))
      }
      ...
      function U(e) {
        e[J] = te++, e._state = undefined, e._result = undefined, e._subscribers = []
      }
      ...
      var W = P,
        ...
        j = void 0,
        F = function (e, t) {
          Z[X] = e, Z[X + 1] = t, 2 === (X += 2) && (j ? j(a) : q())
        },
        H = "undefined" != typeof window ? window : undefined,
        R = H || {},
        T = R.MutationObserver || R.WebKitMutationObserver,
        N = "undefined" == typeof self && !0 && "[object process]" === {}.toString.call(Object({
          env: Object({
            NODE_ENV: "prod"
          })
        })),
      ...
      var J = Math.random().toString(36).substring(2),
        ...
        ne = function () {
          function e(e, t) {
            this._instanceConstructor = e, this.promise = new e(d), this.promise[J] || U(this.promise), W(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? w(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && w(this.promise, this._result))) : B(this.promise, k())
          }
          return e.prototype._enumerate = function (e) {
            ...
            if (r === c) {
              var i = f(e);
              if (i === l && e._state !== K) this._settledAt(e._state, t, e._result);
            ...
            var r = this.promise;
            r._state === K && (this._remaining--, e === _ ? B(r, n) : this._result[t] = n), 0 === this._remaining && w(r, this._result)
          }, e.prototype._willSettleAt = function (e, t) {
            var n = this;
            C(e, undefined, function (e) {
        ...
        re = function () {
          function e(t) {
            this[J] = Q(), this._result = this._state = undefined, this._subscribers = [], d !== t && ("function" != typeof t && O(), this instanceof e ? M(this, t) : Y())
          }
      ...
      return re.prototype.then = l, re.all = I, re.race = S, re.resolve = c, re.reject = D, re._setScheduler = r, re._setAsap = i, re._asap = F, re.polyfill = L, re.Promise = re, re
    })
  }).call(t, n(108))
}, function (e, t, n) {
  "use strict";
  ...
  e.exports = i["default"].clone(o, window.KRCD_EXT_COMPONENTS || {})
}, function (e, t, n) {
  "use strict";
  ...
  e.exports = {
    ...
    moveBorder: function (e, t, n, r, i) {
      ...
      if (A) try {
        ...
        if (l && i)
          for (var c in i) o["default"].setStyleByAttr(l, c, i[c])
      } catch (d) {} else;
    }
  }
}, function (e, t) {
  ...
  function d(e, t) {
    ...
    if (t.singleton) {
      var c = h++;
      n = v || (v = a(t)), r = u.bind(null, n, c, !1), i = u.bind(null, n, c, !0)
    ...
    }) : (n = a(t), r = s.bind(null, n), i = function () {
      A(n)
    });
    return r(e),
      function (t) {
  ...
  e.exports = function (e, t) {
    ...
    t = t || {}, t.attrs = "object" == typeof t.attrs ? t.attrs : {}, t.singleton || "boolean" == typeof t.singleton || (t.singleton = g()), t.insertInto || (t.insertInto = "head"), t.insertAt || (t.insertAt = "bottom");
    var n = i(e, t);
    return r(n, t),
      function (e) {
  ...
  var r = n(6),
    ...
    l = function (e, t, n) {
      ...
      f && (n = t);
      for (c in n)(d = !s && w && w[c] !== undefined) && a(v, c) || (u = d ? w[c] : n[c], v[c] = f && "function" != typeof w[c] ? n[c] : m && d ? o(u, r) : b && w[c] == u ? function (e) {
      ...
      }(u) : g && "function" == typeof u ? o(Function.call, u) : u, g && ((v.virtual || (v.virtual = {}))[c] = u, e & l.R && h && !h[c] && A(h, c, u)))
    };
  ...
  var r = navigator.appVersion.toLowerCase().indexOf("trident") > 0,
    i = r && "MSIE8.0" == navigator.appVersion.split(";")[1].replace(/[ ]/g, ""),
    o = r && "MSIE9.0" == navigator.appVersion.split(";")[1].replace(/[ ]/g, "");
  ...
  o.gecko = "Gecko" == navigator.product && !o.webkit && !o.opera && !o.ie;
  var A = 0;
  if (o.ie) {
    var a = r.match(/(?:msie\s([\w.]+))/),
      l = r.match(/(?:trident.*rv:([\w.]+))/);
    A = a && l && a[1] && l[1] ? Math.max(1 * a[1], 1 * l[1]) : a && a[1] ? 1 * a[1] : l && l[1] ? 1 * l[1] : 0, o.ie11Compat = 11 == document.documentMode, o.ie9Compat = 9 == document.documentMode, o.ie8 = !!document.documentMode, o.ie8Compat = 8 == document.documentMode, o.ie7Compat = 7 == A && !document.documentMode || 7 == document.documentMode, o.ie6Compat = A < 7 || o.quirks, o.ie9above = A > 8, o.ie9below = A < 9, o.ie11above = A > 10, o.ie11below = A < 11
  }
  if (o.gecko) {
    var c = r.match(/rv:([\d\.]+)/);
    c && (c = c[1].split("."), A = 1e4 * c[0] + 100 * (c[1] || 0) + 1 * (c[2] || 0))
  }
  /chrome\/(\d+\.\d)/i.test(r) && (o.chrome = +RegExp.$1), /(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(r) && !/chrome/i.test(r) && (o.safari = +(RegExp.$1 || RegExp.$2)), o.opera && (A = parseFloat(i.version())), o.webkit && (A = parseFloat(r.match(/ applewebkit\/(\d+)/)[1])), o.version = A, o.isCompatible = !o.mobile && (o.ie && A >= 6 || o.gecko && A >= 10801 || o.opera && A >= 9.5 || o.air && A >= 1 || o.webkit && A >= 522 || !1), e.exports = o
}, function (e, t) {
  var n = Math.ceil,
    r = Math.floor;
  e.exports = function (e) {
  ...
  var r = n(18),
    ...
    l = function () {
      var e, t = n(52)("iframe"),
        r = o.length;
      for (t.style.display = "none", n(80).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object<\/script>"), e.close(), l = e.F; r--;) delete l.prototype[o[r]];
      return l()
    };
  e.exports = Object.create || function (e, t) {
    var n;
    return null !== e ? (a.prototype = r(e), n = new a, a.prototype = null, n[A] = e) : n = l(), t === undefined ? n : i(n, t)
  }
}, function (e, t, n) {
  var r = n(54),
    i = n(40);
  ...
  var i = n(104),
    ...
    d = {
      each: function (e, t, n) {
        if (null != e)
          if (e.length === +e.length) {
            ...
            for (var o in e)
              if (e.hasOwnProperty(o) && !1 === t.call(n, e[o], o, e)) return !1
      },
      ...
      inherits: function (e, t) {
        ...
        return d.extend(r, n, !0), e.prototype = r, r.constructor = e
      },
      bind: function (e, t) {
        return function () {
      ...
      indexOf: function (e, t, n) {
        var r = -1;
        return n = this.isNumber(n) ? n : 0, this.each(e, function (e, i) {
      ...
      loadFile: function () {
        ...
        return function (n, r, i) {
          var o = e(n, r);
          if (o) return void(o.ready ? i && i() : o.funs.push(i));
          if (t.push({
              doc: n,
              url: r.src || r.href,
              funs: [i]
            ...
            var A = [];
            for (var a in r) "tag" != a && A.push(a + '="' + r[a] + '"');
            return void n.write("<" + r.tag + " " + A.join(" ") + " ></" + r.tag + ">")
          }
      ...
      fixColor: function (e, t) {
        if (/color/i.test(e) && /rgba?/.test(t)) {
          ...
          t = "#";
          for (var r, i = 0; r = n[i++];) r = parseInt(r.replace(/[^\d]/gi, ""), 10).toString(16), t += 1 == r.length ? "0" + r : r;
          t = t.toUpperCase()
        }
        return t
      },
      optCss: function (e) {
        function t(e, t) {
          ...
          var n = e.top,
            ...
            o = e.right,
            A = "";
          if (n && i && r && o) A += ";" + t + ":" + (n == r && r == i && i == o ? n : n == r && i == o ? n + " " + i : i == o ? n + " " + i + " " + r : n + " " + o + " " + r + " " + i) + ";";
          else
            for (var a in e) A += ";" + t + "-" + a + ":" + e[a] + ";";
          return A
        }
        var n, r;
        return e = e.replace(/(padding|margin|border)\-([^:]+):([^;]+);?/gi, function (e, t, i, o) {
      ...
      clone: function (e, t) {
        var n;
        t = t || {};
        for (var r in e) e.hasOwnProperty(r) && (n = e[r], "object" == (void 0 === n ? "undefined" : (0, a["default"])(n)) ? (t[r] = d.isArray(n) ? [] : {}, d.clone(e[r], t[r])) : t[r] = n);
        return t
      },
      transUnitToPx: function (e) {
        if (!/(pt|cm)/.test(e)) return e;
        var t;
        switch (e.replace(/([\d.]+)(\w+)/, function (n, r, i) {
          e = r, t = i
        }), t) {
          case "cm":
            e = 25 * parseFloat(e);
      ...
      domReady: function () {
        ...
        return function (n, r) {
          r = r || window;
          var i = r.document;
          n && t.push(n), "complete" === i.readyState ? e(i) : (i.isReady && e(i), c["default"].ie && 11 != c["default"].version ? (! function () {
            if (!i.isReady) {
              try {
            ...
            i.removeEventListener("DOMContentLoaded", arguments.callee, !1), e(i)
          }, !1), r.addEventListener("load", function () {
            e(i)
          }, !1)))
        }
      }(),
      cssRule: c["default"].ie && 11 != c["default"].version ? function (e, t, n) {
        var r, i;
        return t === undefined || t && t.nodeType && 9 == t.nodeType ? (n = t && t.nodeType && 9 == t.nodeType ? t : n || document, r = n.indexList || (n.indexList = {}), i = r[e], i !== undefined ? n.styleSheets[i].cssText : undefined) : (n = n || document, r = n.indexList || (n.indexList = {}), i = r[e], "" === t ? i !== undefined && (n.styleSheets[i].cssText = "", delete r[e], !0) : (i !== undefined ? sheetStyle = n.styleSheets[i] : (sheetStyle = n.createStyleSheet("", i = n.styleSheets.length), r[e] = i), void(sheetStyle.cssText = t)))
      } : function (e, t, n) {
        var r;
      ...
      serializeParam: function (e) {
        ...
        for (var n in e)
          if ("method" != n && "timeout" != n && "async" != n)
            if ("function" != (0, a["default"])(e[n]).toLowerCase() && "object" != (0, a["default"])(e[n]).toLowerCase()) t.push(encodeURIComponent(n) + "=" + encodeURIComponent(e[n]));
      ...
      isCrossDomainUrl: function (e) {
        ...
        return t.href = e, c["default"].ie && (t.href = t.href), !(t.protocol == location.protocol && t.hostname == location.hostname && (t.port == location.port || "80" == t.port && "" == location.port || "" == t.port && "80" == location.port))
      },
      ...
      str2json: function (e) {
        return d.isString(e) ? window.JSON ? JSON.parse(e) : new Function("return " + d.trim(e || ""))() : null
      },
      json2str: function () {
        ...
        var e = function (e) {
          ...
          t = function (e) {
            var t, n, r, i = ["["],
              o = e.length;
            for (n = 0; n < o; n++) switch (r = e[n], void 0 === r ? "undefined" : (0, a["default"])(r)) {
              case "undefined":
              case "function":
              case "unknown":
                break;
              default:
                t && i.push(","), i.push(d.json2str(r)), t = 1
            }
        ...
        return function (n) {
          switch (void 0 === n ? "undefined" : (0, a["default"])(n)) {
            case "undefined":
              return "undefined";
            case "number":
            ...
            default:
              ...
              var i, o, A = ["{"],
                l = d.json2str;
              for (var c in n)
                if (Object.prototype.hasOwnProperty.call(n, c)) switch (o = n[c], void 0 === o ? "undefined" : (0, a["default"])(o)) {
                  case "undefined":
                  case "unknown":
                  case "function":
                    break;
                  default:
                    i && A.push(","), i = 1, A.push(l(c) + ":" + l(o))
                }
  ...
  d.each(["String", "Function", "Array", "Number", "RegExp", "Object", "Date"], function (e) {
    d["is" + e] = function (t) {
  ...
  e.exports = function (e, t, n, p, g, m, b) {
    ...
    if (k && (w = d(k.call(new e))) !== Object.prototype && w.next && (c(w, C, !0), r || "function" == typeof w[u] || A(w, u, f)), E && M && "values" !== M.name && (y = !0, Q = function () {
        return M.call(this)
      }), r && !b || !s && !y && x[u] || A(x, u, Q), a[t] = Q, a[C] = f, g)
      if (v = {
          values: E ? Q : B("values"),
          keys: m ? Q : B("keys"),
          entries: U
  ...
  (function (t) {
    var r = n(4),
      ...
      a = n(116),
      l = n(61),
      c = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || n(117);
    e.exports = function (e) {
      return new t(function (t, d) {
        ...
        var f = new XMLHttpRequest,
          ...
          g = !1;
        if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in f || a(e.url) || (f = new window.XDomainRequest, p = "onload", g = !0, f.onprogress = function () {}, f.ontimeout = function () {}), e.auth) {
        ...
        if (f.open(e.method.toUpperCase(), o(e.url, e.params, e.paramsSerializer), !0), f.timeout = e.timeout, f[p] = function () {
          ...
          var v = n(118),
            h = (e.withCredentials || a(e.url)) && e.xsrfCookieName ? v.read(e.xsrfCookieName) : undefined;
          h && (s[e.xsrfHeaderName] = h)
        }
        if ("setRequestHeader" in f && r.forEach(s, function (e, t) {
            void 0 === u && "content-type" === t.toLowerCase() ? delete s[t] : f.setRequestHeader(t, e)
  ...
  var o = n(30),
    ...
    p = l["default"].listToMap(["-webkit-box", "-moz-box", "block", "list-item", "table", "table-row-group", "table-header-group", "table-footer-group", "table-row", "table-column-group", "table-column", "table-cell", "table-caption"]),
    g = {
      NODE_ELEMENT: 1,
      NODE_DOCUMENT: 9,
      NODE_TEXT: 3,
      ...
      getPosition: function (e, t) {
        ...
        for (e = r[o], t = i[o]; e = e.nextSibling;)
          if (e === t) return 4;
        return 2
      },
      ...
      findParent: function (e, t, n) {
        if (e && !g.isBody(e))
          for (e = n ? e : e.parentNode; e;) {
            if (!t || t(e) || g.isBody(e)) return t && !t(e) && g.isBody(e) ? null : e;
            e = e.parentNode
          }
        return null
      },
      findParentByTagName: function (e, t, n, r) {
        return t = l["default"].listToMap(l["default"].isArray(t) ? t : [t]), g.findParent(e, function (e) {
          return t[e.tagName] && !(r && r(e))
        }, n)
      },
      findParents: function (e, t, n, r) {
        for (var i = t && (n && n(e) || !n) ? [e] : []; e = g.findParent(e, n);) i.push(e);
      ...
      remove: function (e, t, n) {
        if (n || !g.hasClassWithStart(e, "krcd-")) {
          var r = e.parentNode,
            i = void 0;
          if (r) {
            if (t && e.hasChildNodes())
              for (; i = e.firstChild;) r.insertBefore(i, e);
            r.removeChild(e)
          }
          return e
        }
      ...
      clearEmptySibling: function (e, t, n) {
        function r(e, t) {
          for (var n = void 0; e && !g.isBookmarkNode(e) && (g.isEmptyInlineElement(e) || !new RegExp("[^\t\n\r" + g.fillChar + "]").test(e.nodeValue));) n = e[t], g.remove(e), e = n
      ...
      on: function (e, t, n) {
        var r = l["default"].isArray(t) ? t : l["default"].trim(t).split(/\s+/),
          i = r.length;
        if (i)
          for (; i--;)
            if (t = r[i], e.addEventListener) e.addEventListener(t, n, !1);
            else {
              n._d || (n._d = {
                els: []
              });
              ...
              n._d[o] && -1 != A || (-1 == A && n._d.els.push(e), n._d[o] || (n._d[o] = function (e) {
      ...
      un: function (e, t, n) {
        ...
        if (i)
          for (; i--;)
            if (t = r[i], e.removeEventListener) e.removeEventListener(t, n, !1);
            else {
              var o = t + n.toString();
              try {
              ...
              if (n._d && n._d[o]) {
                var A = l["default"].indexOf(n._d.els, e); - 1 != A && n._d.els.splice(A, 1), 0 == n._d.els.length && delete n._d[o]
              }
            }
      },
      isSameElement: function (e, t) {
        ...
        for (var o = void 0, A = void 0, a = 0, l = 0, c = 0; o = n[c++];) {
          if ("style" == o.nodeName) {
            if (o.specified && a++, g.isSameStyle(e, t)) continue;
            return !1
          }
          if (u) {
          ...
          if (!A.specified || o.nodeValue != A.nodeValue) return !1
        }
        if (u) {
          for (i = 0; A = r[i++];) A.specified && l++;
          if (a != l) return !1
        }
        return !0
      },
      isSameStyle: function (e, t) {
        ...
        if (A["default"].opera) {
          ...
          for (var i in n)
            if (!/^(\d+|csstext)$/i.test(i) && n[i] != r[i]) return !1;
          return !0
        }
        if (!n || !r) return n == r;
      ...
      isBlockElm: function (e) {
        return 1 == e.nodeType && (d["default"].$block[e.tagName] || p[g.getComputedStyle(e, "display")]) && !d["default"].$nonChild[e.tagName]
      },
      isBody: function (e) {
      ...
      breakParent: function (e, t) {
        var n = void 0,
          ...
          A = void 0;
        do {
          for (r = r.parentNode, o ? (n = r.cloneNode(!1), n.appendChild(o), o = n, n = r.cloneNode(!1), n.appendChild(A), A = n) : (o = r.cloneNode(!1), A = o.cloneNode(!1)); n = i.previousSibling;) o.insertBefore(n, o.firstChild);
          for (; n = i.nextSibling;) A.appendChild(n);
          i = r
        } while (t !== r);
        return n = t.parentNode, n.insertBefore(o, t), n.insertBefore(A, t), n.insertBefore(e, A), g.remove(t), e
      },
      isEmptyInlineElement: function (e) {
        if (1 != e.nodeType || !d["default"].$removeEmpty[e.tagName]) return 0;
      ...
      mergeChild: function (e, t, n) {
        for (var r, i = g.getElementsByTagName(e, e.tagName.toLowerCase()), o = 0; r = i[o++];)
          if (r.parentNode && !g.isBookmarkNode(r))
            if ("span" != r.tagName.toLowerCase()) g.isSameElement(e, r) && g.remove(r, !0);
              ...
              if (r.style.cssText = e.style.cssText + ";" + r.style.cssText, n) {
                ...
                if (A) {
                  A = A.split(";");
                  for (var a, c = 0; a = A[c++];) r.style[l["default"].cssStyleToDomStyle(a.split(":")[0])] = a.split(":")[1]
                }
              }
      ...
      getElementsByTagName: function (e, t, n) {
        ...
        t = l["default"].trim(t).replace(/[ ]{2,}/g, " ").split(" ");
        for (var i, o = [], A = 0; i = t[A++];)
          for (var a, c = e.getElementsByTagName(i), d = 0; a = c[d++];) n && !n(a) || o.push(a);
        return o
      },
      mergeToParent: function (e) {
        for (var t = e.parentNode; t && d["default"].$removeEmpty[t.tagName];) {
      ...
      unSelectable: u && A["default"].ie9below || A["default"].opera ? function (e) {
      ...
      removeAttributes: function (e, t) {
        if (!e || !g.hasClassWithStart(e, "krcd-")) {
          t = l["default"].isArray(t) ? t : l["default"].trim(t).replace(/[ ]{2,}/g, " ").split(" ");
          for (var n, r = 0; n = t[r++];) {
            switch (n = f[n] || n) {
              case "className":
                e[n] = "";
              ...
              case "style":
                ...
                !A["default"].ie && i && e.removeAttributeNode(i)
            }
            e.removeAttribute(n)
          }
        }
      ...
      getComputedStyle: function (e, t) {
        ...
        if (3 == e.nodeType && (e = e.parentNode), A["default"].ie && A["default"].version < 9 && "font-size" == t && !e.style.fontSize && !d["default"].$empty[e.tagName] && !d["default"].$nonChild[e.tagName]) {
        ...
        try {
          g.getStyle(e, t) || (window.getComputedStyle ? g.getWindow(e).getComputedStyle(e, "").getPropertyValue(t) : (e.currentStyle || e.style)[l["default"].cssStyleToDomStyle(t)])
        } catch (i) {
          return ""
        }
        return l["default"].transUnitToPx(l["default"].fixColor(t, value))
      },
      removeClasses: function (e, t) {
        t = l["default"].isArray(t) ? t : l["default"].trim(t).replace(/[ ]{2,}/g, " ").split(" ");
        for (var n, r = e.className, i = 0; n = t[i++];) r = r.replace(new RegExp("\\b" + n + "\\b"), "");
        r = l["default"].trim(r).replace(/[ ]{2,}/g, " "), r ? e.className = r : g.removeAttributes(e, ["class"])
      },
      addClass: function (e, t) {
        if (e) {
          t = l["default"].trim(t).replace(/[ ]{2,}/g, " ").split(" ");
          for (var n, r = e.className, i = 0; n = t[i++];) new RegExp("\\b" + n + "\\b").test(r) || (r += " " + n);
      ...
      hasClass: function (e, t) {
        ...
        var n = void 0,
          r = void 0,
          i = void 0;
        for (n = 0, i = e.className; r = t[n++];)
          if (!new RegExp("\\b" + r + "\\b", "i").test(i)) return !1;
        return n - 1 == t.length
      },
      ...
      removeStyle: function (e, t) {
        A["default"].ie ? ("color" == t && (t = "(^|;)" + t), e.style.cssText = e.style.cssText.replace(new RegExp(t + "[^:]*:[^;]+;?", "ig"), "")) : e.style.removeProperty ? e.style.removeProperty(t) : e.style.removeAttribute(l["default"].cssStyleToDomStyle(t)), e.style.cssText || g.removeAttributes(e, ["style"])
      },
      ...
      setStyle: function (e, t, n) {
        e.style[l["default"].cssStyleToDomStyle(t)] = n, l["default"].trim(e.style.cssText) || this.removeAttributes(e, "style")
      },
      ...
      clearSelectedArr: function (e) {
        for (var t = void 0; t = e.pop();) g.removeAttributes(t, ["class"])
      },
      scrollToView: function (e, t, n) {
        ...
        (i > o || i < o - r) && t.scrollTo(0, i + (i < 0 ? -20 : 20))
      },
      isBr: function (e) {
      ...
      isFillChar: function (e, t) {
        ...
        var n = e.nodeValue;
        return t ? new RegExp("^" + g.fillChar).test(n) : !n.replace(new RegExp(g.fillChar, "g"), "").length
      },
      isStartInblock: function (e) {
        ...
        if (1 == r.nodeType && r.childNodes[t.startOffset]) {
          ...
          for (var o = r.previousSibling; o && g.isFillChar(o);) r = o, o = o.previousSibling
        }
        for (this.isFillChar(r, !0) && 1 == t.startOffset && (t.setStartBefore(r), r = t.startContainer); r && g.isFillChar(r);) i = r, r = r.previousSibling;
        for (i && (t.setStartBefore(i), r = t.startContainer), 1 == r.nodeType && g.isEmptyNode(r) && 1 == t.startOffset && t.setStart(r, 0).collapse(!0); !t.startOffset;) {
          if (r = t.startContainer, g.isBlockElm(r) || g.isBody(r)) {
            n = 1;
            break
          }
          var A = t.startContainer.previousSibling,
            a = void 0;
          if (A) {
            for (; A && g.isFillChar(A);) a = A, A = A.previousSibling;
            a ? t.setStartBefore(a) : t.setStartBefore(t.startContainer)
      ...
      isEmptyBlock: function (e, t) {
        ...
        if (t = t || new RegExp("[  \t\r\n" + g.fillChar + "]", "g"), e[A["default"].ie ? "innerText" : "textContent"].replace(t, "").length > 0) return 0;
      ...
      setViewportOffset: function (e, t) {
        var n = 0 | parseInt(e.style.left),
          ...
          o = t.left - i.left,
          A = t.top - i.top;
        o && (e.style.left = n + o + "px"), A && (e.style.top = r + A + "px")
      },
      fillNode: function (e, t) {
        var n = A["default"].ie ? e.createTextNode(g.fillChar) : e.createElement("br");
      ...
      hasNoAttributes: function (e) {
        return A["default"].ie ? /^<\w+\s*?>/.test(e.outerHTML) : 0 == e.attributes.length
      },
      ...
      filterNodeList: function (e, t, n) {
        ...
        if (!l["default"].isFunction(t)) {
          var i = t;
          t = function (e) {
            return -1 != l["default"].indexOf(l["default"].isArray(i) ? i : i.split(" "), e.tagName.toLowerCase())
          }
        }
        return l["default"].each(e, function (e) {
          t(e) && r.push(e)
  ...
  var i = n(5),
    ...
    c = function (e, t, n) {
      t = t.toLowerCase();
      try {
        var r = (e[l.kernel] ? e[l.kernel][l.__allListeners] : null) || e[l.__allListeners];
    ...
    d = function () {
      function e(t) {
        (0, o["default"])(this, e), t = t || {}, this[l.__allListeners] = t
      }
      return e.prototype.addListener = function (e, t) {
        ...
        for (var r, i = 0; r = e[i++];) {
          var o = c(this, r, n);
          o ? o.push(t) : console.warn("系统未定义 [" + r + "] 事件！")
        }
      }, e.prototype.createListener = function (e, t) {
        e = a["default"].trim(e).split(/\s+/);
        for (var n, r = 0; n = e[r++];) {
          c(this, n, !1) ? console.warn("系统已存在 [" + n + "] 事件！") : (this[l.__allListeners][n] = [], t && this[l.__allListeners][n].push(t))
        }
        ...
        e = a["default"].trim(e).split(/\s+/);
        for (var n, r = 0; n = e[r++];) a["default"].removeItem(c(this, n) || [], t)
      }, e.prototype.fireEvent = function (e) {
        e = a["default"].trim(e).split(/\s+/);
        for (var t = void 0, n = arguments.length, r = Array(n > 1 ? n - 1 : 0), i = 1; i < n; i++) r[i - 1] = arguments[i];
        for (var o, A = 0; o = e[A++];) {
          var l = c(this, o),
            d = void 0,
            u = void 0;
          if (l)
            for (u = l.length; u--;)
              if (l[u]) {
                if (!0 === (d = l[u].apply(this, r))) return d;
                d !== undefined && (t = d)
              }(d = this["on" + o.toLowerCase()]) && (t = d.apply(this, r))
        }
        return t
      }, e
    }();
  ...
  e.exports = function (e) {
    return function (t, n) {
      var o, A, a = String(i(t)),
        l = r(n),
        c = a.length;
      return l < 0 || l >= c ? e ? "" : undefined : (o = a.charCodeAt(l), o < 55296 || o > 56319 || l + 1 === c || (A = a.charCodeAt(l + 1)) < 56320 || A > 57343 ? e ? a.charAt(l) : o : e ? a.slice(l, l + 2) : A - 56320 + (o - 55296 << 10) + 65536)
    }
  }
}, function (e, t) {
  e.exports = function (e) {
  ...
  e.exports = n(14) ? Object.defineProperties : function (e, t) {
    i(e);
    for (var n, A = o(t), a = A.length, l = 0; a > l;) r.f(e, n = A[l++], t[n]);
    return e
  }
}, function (e, t, n) {
  var r = n(55);
  ...
  var r = n(6),
    ...
    G = F && "symbol" == typeof S.iterator ? function (e) {
      return "symbol" == typeof e
    } : function (e) {
      return e instanceof S
    },
    Z = function (e, t, n) {
      return e === j && Z(V, t, n), v(e), t = B(t, !0), v(n), i(X, t) ? (n.enumerable ? (i(e, Y) && e[Y][t] && (e[Y][t] = !1), n = E(n, {
        enumerable: C(0, !1)
      })) : (i(e, Y) || k(e, Y, C(1, {})), e[Y][t] = !0), T(e, t, n)) : k(e, t, n)
    },
    q = function (e, t) {
      v(e);
      for (var n, r = m(t = w(t)), i = 0, o = r.length; o > i;) Z(e, n = r[i++], t[n]);
      return e
    },
    J = function (e, t) {
    ...
    K = function (e) {
      ...
      return !(this === j && i(X, e) && !i(V, e)) && (!(t || !i(this, e) || !i(X, e) || i(this, Y) && this[Y][e]) || t)
    },
    z = function (e, t) {
      if (e = w(e), t = B(t, !0), e !== j || !i(X, t) || i(V, t)) {
        var n = U(e, t);
        return !n || !i(X, t) || i(e, Y) && e[Y][t] || (n.enumerable = !0), n
      }
    },
    _ = function (e) {
      for (var t, n = I(w(e)), r = [], o = 0; n.length > o;) i(X, t = n[o++]) || t == Y || t == l || r.push(t);
      return r
    },
    ee = function (e) {
      for (var t, n = e === j, r = I(n ? V : w(e)), o = [], A = 0; r.length > A;) !i(X, t = r[A++]) || n && !i(j, t) || o.push(X[t]);
      return o
    };
  F || (S = function () {
    ...
    var e = s(arguments.length > 0 ? arguments[0] : undefined),
      t = function (n) {
        this === j && t.call(V, n), i(this, Y) && i(this[Y], e) && (this[Y][e] = !1), T(this, e, C(1, n))
      };
    return o && R && T(j, e, {
      configurable: !0,
      set: t
    ...
    return this._k
  }), x.f = z, M.f = Z, n(57).f = y.f = _, n(45).f = K, n(56).f = ee, o && !n(33) && a(j, "propertyIsEnumerable", K, !0), p.f = function (e) {
    return N(f(e))
  }), A(A.G + A.W + A.F * !F, {
    Symbol: S
  });
  ...
  A(A.S + A.F * !F, "Symbol", {
    ...
    stringify: function (e) {
      ...
      if (n = t = r[1], (h(t) || e !== undefined) && !G(e)) return b(t) || (t = function (e, t) {
        if ("function" == typeof n && (t = n.call(this, e, t)), !G(t)) return t
      }), r[1] = t, O.apply(D, r)
    }
  }), S.prototype[L] || n(11)(S.prototype, L, S.prototype.valueOf), u(S, "Symbol"), u(Math, "Math", !0), u(r.JSON, "JSON", !0)
}, function (e, t, n) {
  var r = n(27)("meta"),
    i = n(13),
    o = n(7),
  ...
  e.exports = function (e) {
    var t = r(e),
      n = i.f;
    if (n)
      for (var A, a = n(e), l = o.f, c = 0; a.length > c;) l.call(e, A = a[c++]) && t.push(A);
    return t
  }
}, function (e, t, n) {
  var r = n(55);
  ...
  e.exports = {
    set: Object.setPrototypeOf || ("__proto__" in {} ? function (e, t, r) {
      try {
        r = n(50)(Function.call, n(58).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
      } catch (i) {
        t = !0
      }
      return function (e, n) {
  ...
  var r = n(5),
    ...
    a = function () {
      function e(t) {
        (0, i["default"])(this, e), this[o.kernel] = t, t.ikrcd = this
      }
      return e.prototype.addListener = function (e, t) {
        if (this[o.kernel].addListener) return this[o.kernel].addListener(e, t);
        A("addListener 不存在！")
      }, e.prototype.createListener = function (e, t) {
        if (this[o.kernel].createListener) return this[o.kernel].createListener(e, t);
        ...
        if (this[o.kernel].trigger) return this[o.kernel].trigger();
        A("trigger 不存在！")
      }, e.prototype.removeListener = function (e, t) {
        if (this[o.kernel].removeListener) return this[o.kernel].removeListener(e, t);
        A("removeListener 不存在！")
      }, e.prototype.fireEvent = function () {
        if (this[o.kernel].fireEvent) return this[o.kernel].fireEvent.apply(this, arguments);
        A("fireEvent 不存在！")
      }, e.prototype.destroy = function () {
        if (this[o.kernel].destroy) return this[o.kernel].destroy();
        A("destroy 不存在！")
      }, e.prototype.insertHTML = function (e) {
        if (this[o.kernel].insertHTML) return this[o.kernel].insertHTML(e);
        A("insertHTML 不存在！")
      }, e.prototype.insertControl = function (e, t) {
        if (this[o.kernel].insertControl) return this[o.kernel].insertControl(e, t);
        A("insertControl 不存在！")
        ...
        var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        if (this[o.kernel].assistant) return this[o.kernel].assistant(e);
        A("assistant 不存在！")
      }, e.prototype.getControlById = function (e) {
        if (this[o.kernel].getControlById) return this[o.kernel].getControlById(e);
        A("getControlById 不存在！")
      }, e.prototype.getControlByEl = function (e) {
        if (this[o.kernel].getControlByEl) return this[o.kernel].getControlByEl(e);
        A("getControlByEl 不存在！")
      }, e.prototype.importXML = function (e) {
        if (this[o.kernel].importXML) return this[o.kernel].importXML(e);
        A("importXML 不存在！")
      }, e.prototype.exportXML = function () {
        if (this[o.kernel].exportXML) return this[o.kernel].exportXML();
        A("exportXML 不存在！")
      }, e.prototype.downloadXML = function () {
        if (this[o.kernel].downloadXML) return this[o.kernel].downloadXML();
        A("downloadXML 不存在！")
      }, e.prototype.createCtrl = function (e, t) {
        if (this[o.kernel].createCtrl) return this[o.kernel].createCtrl(e, t);
        A("createCtrl 不存在！")
      }, e.prototype.execCommand = function () {
        if (this[o.kernel].createCtrl) return this[o.kernel].execCommand.apply(this[o.kernel], arguments);
        A("execCommand 不存在！")
      }, e
    }();
  e.exports = a
  ...
  (function (t) {
    ...
    }, l.Cancel = n(63), l.CancelToken = n(124), l.isCancel = n(62), l.all = function (e) {
      return t.all(e)
  ...
  function i(e) {
    for (var t, n, i = String(e), A = "", a = 0, l = o; i.charAt(0 | a) || (l = "=", a % 1); A += l.charAt(63 & t >> 8 - a % 1 * 8)) {
  ...
  e.exports = r.isStandardBrowserEnv() ? function () {
    return {
      write: function (e, t, n, i, o, A) {
        var a = [];
        a.push(e + "=" + encodeURIComponent(t)), r.isNumber(n) && a.push("expires=" + new Date(n).toGMTString()), r.isString(i) && a.push("path=" + i), r.isString(o) && a.push("domain=" + o), !0 === A && a.push("secure"), document.cookie = a.join("; ")
      },
      read: function (e) {
  ...
  (function (t) {
    ...
    var i = n(4),
      ...
      c = n(123);
    e.exports = function (e) {
      return r(e), e.baseURL && !l(e.url) && (e.url = c(e.baseURL, e.url)), e.headers = e.headers || {}, e.data = o(e.data, e.headers, e.transformRequest), e.headers = i.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers || {}), i.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function (t) {
        delete e.headers[t]
      }), (e.adapter || a.adapter)(e).then(function (t) {
        return r(e), t.data = o(t.data, t.headers, e.transformResponse), t
      }, function (n) {
        return A(n) || (r(e), n && n.response && (n.response.data = o(n.response.data, n.response.headers, e.transformResponse))), t.reject(n)
      })
    }
  }).call(t, n(19))
}, function (e, t, n) {
  ...
  var B = function (e) {
    function t(n) {
      (0, o["default"])(this, t), h["default"].extend(n, g["default"], !0);
      var r = new f["default"](n),
        i = (0, a["default"])(this, e.call(this, r));
      return i[w.kernel][w.__private__].ue.__krcd__ = i, i
    }
  ...
  var i = n(5),
    ...
    E = r(C),
    y = function (e, t) {
      e.appendChild(B["default"].createElement(document, "div", {
        "class": "bg"
      }));
      ...
      n.innerHTML = r.innerHTML = "<div class='content'></div>", e.appendChild(n), e.appendChild(r)
    },
    x = function (e, t, n) {
      var r = e.toolbars ? 143 : 0,
        ...
        o = B["default"].createElement(document, "div", {
          style: "width:" + t.offsetWidth + "px;height:" + (t.offsetHeight - r) + "px;"
        }),
        A = B["default"].createElement(document, "div", {
          "class": "krcd-editor"
        }),
        a = B["default"].createElement(document, "div", {
          "class": "krcd-editor-footer"
        }),
        ...
        d = B["default"].createElement(document, "div", {
          "class": "krcd-editor-pager",
          style: "width:" + e.outer_width + "px;height:" + e.page_height + "px;"
        }),
        u = B["default"].createElement(document, "div", {
          "class": "krcd-editor-inner",
          style: "width:" + e.inner_width + "px;margin:0 auto;"
        });
      for (u.innerHTML = '<div>&nbsp;</div><script id="' + n + '" type="text/plain" defer style="width:100%;height:100%;">' + t.innerHTML + "<\/script>"; u.firstChild && (!u.firstChild.nodeName || "SCRIPT" !== u.firstChild.nodeName);) u.removeChild(u.firstChild);
      l.appendChild(u), l.appendChild(d), y(c, e), A.appendChild(l), a.innerHTML = e.footer, A.appendChild(a), t.innerHTML = "", e.toolbars && t.appendChild(i), o.appendChild(A), o.appendChild(c), t.appendChild(o)
    },
    M = function (e) {
      function t(n) {
        (0, o["default"])(this, t);
        var r = (0, a["default"])(this, e.call(this, h["default"].clone(f["default"], {})));
        if (r.name = "design", !n.el) return console.error("el对象为空！"), (0, a["default"])(r);
        var i = null;
        h["default"].isString(n.el) ? i = document.querySelector(n.el) : B["default"].isElement(n.el) && (i = n.el);
        var A = [],
          l = window.IKRCDBUGGER ? "?" + (new Date).getTime() : "";
        b.isIE8 && window.KRCD_CONFIG.IE8_SCRIPT && window.KRCD_CONFIG.IE8_SCRIPT.length && h["default"].each(window.KRCD_CONFIG.IE8_SCRIPT, function (e) {
          A.push(e)
        }), A.push(KRCD_CONFIG.EDITOR_URL + l), h["default"].isString(n.iframe_js_src) ? A.push(n.iframe_js_src + l) : h["default"].isArray(n.iframe_js_src) && h["default"].each(n.iframe_js_src, function (e) {
        ...
        if (n._isinit = !1, r[p.__private__] = {
            rootDom: i,
            ue: d,
            editor: null,
            options: n
          }, n.toolbars) {
          var u = i.querySelector(".krcd-toolbars");
          E["default"].call(r, u, n)
        }
        return (0, m["default"])(r), r
      }
      return (0, c["default"])(t, e), t.prototype.addListener = function (t, n) {
        e.prototype.addListener.call(this.ikrcd, t, n, !1)
      }, t.prototype.insertHTML = function (e) {
        this[p.__private__].editor && (this[p.__private__].editor.insertHTML(e), this.fireEvent.call(this.ikrcd, "contentchange"))
      }, t.prototype.insertControl = function (e, t) {
        this[p.__private__].ue.execCommand("insertControl", e, t)
      }, t.prototype.mode = function () {
        var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        if (!e) return this[p.__private__].options.mode;
        this[p.__private__].options.mode = e, this[p.__private__].ue.options.enableContextMenu = "READONLY" !== e, this[p.__private__].editor.mode(e)
      }, t.prototype.assistant = function () {
        var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        if (null === e) return this[p.__private__].options.openassistant;
        this[p.__private__].options.openassistant !== e && (this[p.__private__].options.openassistant = e, this[p.__private__].editor.assistant(e))
      }, t.prototype.html = function () {
        var e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        if (this[p.__private__].editor) {
          if (!e) return this[p.__private__].editor.html();
          this[p.__private__].editor.html(e), this.fireEvent.call(this.ikrcd, "contentchange")
        }
        ...
        return this[p.__private__].editor ? this[p.__private__].editor.getControlByEl(e) : null
      }, t.prototype.getControlById = function (e) {
        return this[p.__private__].editor ? this[p.__private__].editor.getControlById(e) : null
      }, t.prototype.createCtrl = function (e, t) {
        return this[p.__private__].editor ? this[p.__private__].editor.createCtrl(e, t) : null
      }, t.prototype.importXML = function (e) {
        this[p.__private__].editor && this[p.__private__].editor.importXML(e)
      }, t.prototype.exportXML = function () {
        return this[p.__private__].editor ? this[p.__private__].editor.exportXML() : null
      }, t.prototype.downloadXML = function () {
        return this[p.__private__].editor ? this[p.__private__].editor.downloadXML() : null
      }, t
    }(u["default"]);
  e.exports = M
}, function (e, t, n) {
  ...
  var i = n(3),
    ...
    f = function (e) {
      var t = e[i.__private__],
        n = t.rootDom.querySelector(".krcd-editor-page_header_footer");
      t.options.toolbars && t.options.toolbars.length > 0 ? n.style.top = -1 * (t.rootDom.offsetHeight - 143) + "px" : n.style.top = -1 * t.rootDom.offsetHeight + "px", e.addListener("headerfooteropen", function (e, r) {
        n.style.display = "block";
        var i = n.querySelector("div.header>div.content"),
          o = n.querySelector("div.footer>div.content");
        i.innerHTML = t.options.page_header_footer.header() || d["default"].getSpace(), o.innerHTML = t.options.page_header_footer.footer() || d["default"].getSpace(), i.style.width = o.style.width = t.options.outer_width + "px"
    ...
    p = function (e) {
      ...
      n.addListener("ready", function () {
        function r() {
          n.window.KRCD ? t.editor = n.window.krcd = new n.window.KRCD({
            el: n.document.body,
            openassistant: t.options.openassistant,
            mode: t.options.mode,
            ctrl_remote_handle: t.options.ctrl_remote_handle,
            ikrcdsign: !0
          }) : setTimeout(r, 100), t.options._isinit = !0
        }
        n.window.KRCD ? r() : setTimeout(r, 0), (0, s["default"])(e), f(e);
        var i = t.ueDom = t.rootDom.querySelector(".krcd-editor-inner").firstChild;
        (0, l["default"])(e, i), e.fireEvent.call(e.ikrcd, "ready")
      }), n.addListener("selectionchange", function () {
        e.fireEvent.call(e.ikrcd, "selectionchange")
      }), n.addListener("contentchange", function () {
        (0, l["default"])(e), e.fireEvent.call(e.ikrcd, "contentchange", e.ikrcd)
      }), A["default"].call(e, n)
    };
  e.exports = p
}, function (e, t, n) {
    ...
    init: function (e) {
      var t = new baidu.editor.ui.Popup({
        ...
        _setIframeAlign: function (e) {
          ...
          n.parentNode.insertBefore(r, n), o["default"].remove(n), t.anchorEl = r, t.showAnchor(t.anchorEl)
        },
        _updateIframe: function () {
          var n = e._iframe = t.anchorEl;
          o["default"].hasClass(n, "ueditor_baidumap") ? (e.selection.getRange().selectNode(n).select(), e.ui._dialogs.mapDialog.open(), t.hide()) : (e.ui._dialogs.insertframeDialog.open(), t.hide())
        },
        _onRemoveButtonClick: function (t) {
          e.execCommand(t), this.hide()
        },
        queryAutoHide: function (n) {
          return n && n.ownerDocument == e.document && ("img" == n.tagName.toLowerCase() || o["default"].findParentByTagName(n, "a", !0)) ? n !== t.anchorEl : baidu.editor.ui.Popup.prototype.queryAutoHide.call(this, n)
        }
      });
      t.render(), e.options.imagePopup && e.addListener("selectionchange", function (n, r) {
        if (r) {
          var i = "",
            A = "",
          ...
          e.ui._dialogs;
          if (a && "IMG" == a.tagName) {
            var l = "insertimageDialog"; - 1 == a.className.indexOf("edui-faked-video") && -1 == a.className.indexOf("edui-upload-video") || (l = "insertvideoDialog"), -1 != a.className.indexOf("edui-faked-webapp") && (l = "webappDialog"), -1 != a.src.indexOf("http://api.map.baidu.com") && (l = "mapDialog"), -1 != a.className.indexOf("edui-faked-music") && (l = "musicDialog"), -1 != a.src.indexOf("http://maps.google.com/maps/api/staticmap") && (l = "gmapDialog"), a.getAttribute("anchorname") && (l = "anchorDialog", i = t.formatHtml("<nobr>" + e.getLang("property") + ': <span onclick=$$._onImgEditButtonClick("anchorDialog") class="edui-clickable">' + e.getLang("modify") + "</span>&nbsp;&nbsp;<span onclick=$$._onRemoveButtonClick('anchor') class=\"edui-clickable\">" + e.getLang("delete") + "</span></nobr>")), a.getAttribute("word_img") && (e.word_img = [a.getAttribute("word_img")], l = "wordimageDialog"), (o["default"].hasClass(a, "loadingclass") || o["default"].hasClass(a, "loaderrorclass")) && (l = ""), A = "<nobr>" + e.getLang("property") + ': <span onclick=$$._onImgSetFloat("none") class="edui-clickable">' + e.getLang("default") + '</span>&nbsp;&nbsp;<span onclick=$$._onImgSetFloat("left") class="edui-clickable">' + e.getLang("justifyleft") + '</span>&nbsp;&nbsp;<span onclick=$$._onImgSetFloat("right") class="edui-clickable">' + e.getLang("justifyright") + '</span>&nbsp;&nbsp;<span onclick=$$._onImgSetFloat("center") class="edui-clickable">' + e.getLang("justifycenter") + "</span>&nbsp;&nbsp;<span onclick=\"$$._onImgEditButtonClick('" + l + '\');" class="edui-clickable">' + e.getLang("modify") + "</span></nobr>", !i && (i = t.formatHtml(A))
          }
          if (e.ui._dialogs.linkDialog) {
            ...
            if (c && (d = c.getAttribute("_href") || c.getAttribute("href", 2))) {
              var u = d;
              d.length > 30 && (u = d.substring(0, 20) + "..."), i && (i += '<div style="height:5px;"></div>'), i += t.formatHtml("<nobr>" + e.getLang("anthorMsg") + ': <a target="_blank" href="' + d + '" title="' + d + '" >' + u + '</a> <span class="edui-clickable" onclick="$$._onEditButtonClick();">' + e.getLang("modify") + '</span> <span class="edui-clickable" onclick="$$._onRemoveButtonClick(\'unlink\');"> ' + e.getLang("clear") + "</span></nobr>"), t.showAnchor(c)
            }
          }
          i ? (t.getDom("content").innerHTML = i, t.anchorEl = a || link, t.showAnchor(t.anchorEl)) : t.hide()
        }
      })
    }
  }
  ...
  var i = n(1),
    ...
    c = function (e, t, n, r) {
      for (var i = Math.ceil(e / t), o = [], A = 0; A < i; A++) {
        var a = i === A + 1 ? e - t * A : t;
        o.push('<div page="' + A + '" class="krcd-editor-pager-page" style="height:' + (0 === A ? a : a - 2) + "px;" + (0 === A ? "border-top:none;" : "") + '">\n                <div class="krcd-page-header">页眉</div>\n                <div class="krcd-page-footer">页脚</div>\n                <div class="krcd-page-num">' + (A + r + 1) + "</div>\n              </div>")
      }
      n.innerHTML = o.join("")
    },
    d = function (e, t) {
      var n = e[l.__private__],
        r = !!t;
      r || (t = n.ueDom = n.rootDom.querySelector(".krcd-editor-inner").firstChild);
      var i = n.rootDom.querySelector(".krcd-editor-pager");
      i && (r && (o["default"].registerEvent(i, "click", function (t) {
        t = t || window.event;
        var n = t.target || t.srcElement,
          r = a["default"].hasClass(n, "krcd-page-header") || a["default"].hasClass(n, "krcd-page-footer");
        r && e.ikrcd.fireEvent("headerfooteropen", r ? "header" : "footer", parseInt(n.parentElement.getAttribute("page")))
      }), o["default"].registerEvent(n.rootDom.querySelector("div.krcd-editor-page_header_footer>div.bg"), "click", function () {
        e.ikrcd.fireEvent("headerfooterclose")
      })), c(t.offsetHeight - 25, n.options.page_height, i, n.options.page_start_num - 1))
    };
  e.exports = d
}, function (e, t, n) {
  "use strict";
  ...
  e.exports = function (e) {
    ...
    t.addListener("beforerender", function () {
      ...
      e.ikrcd.fireEvent("rendered", t)
    }), t.addListener("click", function (t, n) {
      e.ikrcd.fireEvent("click", t, n)
    }), t.addListener("valuechange", function (t, n) {
      e.ikrcd.fireEvent("valuechange", t, n)
    })
  }
}, function (e, t, n) {
  "use strict";
  ...
  var i = n(2),
    ...
    Xn = n(235),
    Vn = r(Xn),
    jn = [c["default"], mt["default"], vt["default"], Yt["default"], Ut["default"], Xt["default"], lt["default"], dt["default"], st["default"], wt["default"], pt["default"], Ct["default"], Mt["default"], Tt["default"], Ke["default"], et["default"], nt["default"], it["default"], At["default"], Ht["default"], un["default"], Ue["default"], Ye["default"], Pe["default"], qe["default"], _e["default"], jt["default"], en["default"], Ge["default"], Xe["default"], je["default"], He["default"], Te["default"], yt["default"], _t["default"], Ce["default"], Ie["default"], ye["default"], Me["default"], De["default"], It["default"], cn["default"], pe["default"], me["default"], qt["default"], ee["default"], ve["default"], we["default"], Dt["default"], fn["default"], le["default"], L["default"], Ae["default"], J["default"], Kt["default"], b["default"], Pt["default"], gn["default"], u["default"], se["default"], f["default"], Z["default"], de["default"], ie["default"], ne["default"], Gt["default"], bn["default"], z["default"], V["default"], N["default"], F["default"], R["default"], O["default"], g["default"], an["default"], hn["default"], W["default"], Q["default"], k["default"], S["default"], h["default"], E["default"], x["default"], B["default"], nn["default"], on["default"], Bn["default"], En["default"], xn["default"], Qn["default"], kn["default"], Sn["default"], On["default"], Ln["default"], Wn["default"], Vn["default"]];
  e.exports = function (e, t) {
    function n(e) {
      if (e && jn && jn.length > 0)
    ...
    function r(e) {
      ...
      return a["default"].each(e.items, function (e) {
        if (a["default"].isString(e) && "|" === e) return void A.appendChild(o["default"].createElement(document, "div", {}));
        if (e.render) {
          var t = e.render.call(i);
          if (a["default"].isString(t)) {
            var r = document.createElement("div");
            r.innerHTML = t, a["default"].each(r.childNodes, function (e) {
              A.appendChild(e)
            })
          } else o["default"].isElement(t) ? A.appendChild(t) : (console.error("render必须返回Element对象或者string类型的值！"), console.error(e))
        } else {
          var l = n(e.name);
          l && A.appendChild(l.render.call(i, e))
        }
      }), r.innerHTML = e.title, t.appendChild(r), t.appendChild(A), t
    }
    if (t && t.toolbars) {
      var i = this;
      ! function () {
        ...
        a["default"].each(t.toolbars, function (e, A) {
          var l = !!t.default_open_toolbar && t.default_open_toolbar === e.name || !t.default_open_toolbar && 0 === A,
            c = o["default"].createElement(document, "li", {
              "class": "tab-list-item" + (l ? " tab-list-item-active" : ""),
              name: e.name
            }),
          ...
          a["default"].each(e.items, function (e) {
            var t = r(e);
            t && d.appendChild(t)
          }), c.innerHTML = e.title, n.appendChild(c), i.appendChild(d)
        }), a["default"].registerEvent(n, "click", function (e) {
          var t = o["default"].formatEvt(e),
            n = (t.evt, t.target);
          if ("LI" === n.nodeName && !o["default"].hasClass(n, "tab-list-item-active")) {
            a["default"].each(n.parentElement.querySelectorAll(".tab-list-item-active"), function (e) {
              var t = e.getAttribute("name");
              if (t) {
                var n = i.querySelector('div[name="' + t + '"]');
                n && (n.style.display = "none", o["default"].removeClasses(n, "tab-content-item-active"))
              }
              o["default"].removeClasses(e, "tab-list-item-active")
            }), o["default"].addClass(n, "tab-list-item-active");
            var r = n.getAttribute("name");
            if (r && !(r.length <= 0)) {
              var A = i.querySelector('div[name="' + r + '"]');
              A && (A.setAttribute("style", "display:inline!important"), o["default"].addClass(A, "tab-content-item-active"))
            }
          }
  ...
  e.exports = {
    ...
    render: function (e) {
      var t = this;
      return r.getSmallBtn.call(t, e, function (e) {
  ...
  e.exports = {
    ...
    render: function (e) {
      var t = this;
      return r.getBigBtn.call(t, e, function (e) {
        return !1
      }, function (e) {
        alert("暂未实现！")
      })
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return r.getBigBtn.call(t, e, function (e) {
        ...
        n.setAttribute("type", "file"), n.onchange = function (e) {
          var n = e.target;
          if (n.files && n.files.length) {
            ...
            if (r.name.toLowerCase().endsWith(".xml")) {
              ...
              i.onload = function (e) {
                t.importXML(e.target.result.toString())
              }, i.readAsText(r)
  ...
  e.exports = {
    ...
    render: function (e) {
      var t = this,
        n = r.getSmallBtn.call(t, e, function (e) {
          return e.queryCommandValue("link") ? (n.lastElementChild.innerHTML = "修改链接", !0) : (n.lastElementChild.innerHTML = "添加链接", -1 !== e.queryCommandState(i))
        }, function (e) {
          e.execCommand(i)
        });
      return n
    ...
    render: function (e) {
      var t = this,
        n = r.getSmallBtn.call(t, e, function (e) {
          ...
          if (t) {
            var r = t.contentWindow.document.querySelector("input[type=file]");
            r && r.click()
          }
        });
      return t[i.__private__].ue.fireEvent("simpleuploadbtnready", n), n
    }
  }
}, function (e, t, n) {
  "use strict";
  ...
  var i = n(0),
    ...
    l = r(a),
    c = function () {
      for (var e = A["default"].createElement(document, "table", {}), t = 0; t < 10; t++) {
        for (var n = A["default"].createElement(document, "tr", {}), r = 0; r < 10; r++) {
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      var n = this,
        ...
        f = c();
      t(0, 0), s.appendChild(f), d.appendChild(u), d.appendChild(s), o.appendChild(a), o.appendChild(d), l["default"].registerEvent(f, "mouseover", function (e) {
        ...
        if ("TD" === r.nodeName) {
          var i = r.getAttribute("data").split(","),
            ...
            a = parseInt(i[1]);
          t(o + 1, a + 1);
          for (var l = 0, c = f.childElementCount; l < c; l++) {
            var d = f.children[l];
            if (l > o && "" === d.children[0].className) break;
            for (var u = 0, s = d.childElementCount; u < s; u++) {
              var p = d.children[u];
      ...
      var p = i.getBigBtn.call(n, e, function (e) {
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      var n = a.getSelectBigBtn.call(t, e, function (e, t) {
          return !0
        }, function (e) {
          ...
          if (n) {
            var r = o["default"].findParent(n, function (e) {
              return "TABLE" === e.nodeName
            }, !0);
            if (!r) return;
            t.selected ? o["default"].removeClasses(r, t.name) : o["default"].addClass(r, t.name)
          }
        }),
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      var n = r.getSelectBtn.call(t, 64, e, function (t, n) {
          for (var r = t.queryCommandValue(i), o = {
              name: "",
              title: "无"
            }, A = 0, a = e.items.length; A < a; A++) e.items[A].name === r ? (e.items[A].selected = !0, o.name = r, o.title = e.items[A].title) : e.items[A].selected = !1;
          return n(o), !0
        }, function (e) {
          return " font-family: " + e.name + "; font-size: 14px;line-height:25px;"
        }, function (e, t) {
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      var n = r.getSelectBtn.call(t, 30, e, function (t, n) {
        for (var r = t.queryCommandValue(i), o = {
            title: "12px",
            name: "12"
          }, A = 0, a = e.items.length; A < a; A++) e.items[A].name + "px" === r ? (e.items[A].selected = !0, o.name = r, o.title = e.items[A].title) : e.items[A].selected = !1;
        return n(o), !0
      }, function (e) {
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return e.items || (e.items = [{
        ...
        title: "■ 方形项目符号",
        name: "square"
      }]), r.getSelectBtn.call(t, null, e, function (t, n) {
        for (var r = t.queryCommandValue("insertunorderedlist"), i = {
            title: "○ 空心项目符号",
            name: "circle"
          }, o = 0, A = e.items.length; o < A; o++) e.items[o].name === r ? (e.items[o].selected = !0, i.name = r, i.title = e.items[o].title) : e.items[o].selected = !1;
        return n(i), !0
      }, function (e) {
        return "font-size: 14px;line-height:25px;"
      }, function (e, t) {
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return e.items || (e.items = [{
        ...
        for (var r = t.queryCommandValue("insertorderedlist"), i = {
            title: "1., 2., 3., 4.,",
            name: "decimal"
          }, o = 0, A = e.items.length; o < A; o++) e.items[o].name === r ? (e.items[o].selected = !0, i.name = r, i.title = e.items[o].title) : e.items[o].selected = !1;
        return n(i), !0
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return e.items || (e.items = [{
        ...
        for (var r = t.queryCommandValue("rowspacing"), i = {
            title: "5px",
            name: "5"
          }, o = 0, A = e.items.length; o < A; o++) e.items[o].name + "px" === r ? (e.items[o].selected = !0, i.name = r, i.title = e.items[o].title) : e.items[o].selected = !1;
        return n(i), !0
      }, function (e) {
        return "font-size: 14px;line-height:25px;"
      }, function (e, t) {
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return e.items || (e.items = [{
        ...
        for (var r = t.queryCommandValue(i).toString(), o = {
            title: "1",
            name: "1"
          }, A = 0, a = e.items.length; A < a; A++) e.items[A].name === r ? (e.items[A].selected = !0, o.name = r, o.title = e.items[A].title) : e.items[A].selected = !1;
        return n(o), !0
  ...
  e.exports = {
    ...
    render: function (e) {
      var t = this;
      return r.getSelectBtnNoBorder.call(t, e, function (e) {
        return !0
      }, function (e) {
        return ""
      }, function (e, t) {
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      var n = r.getSelectBigBtn.call(t, e, function (e, t) {
          return !0
        }, function (e) {
          return "font-size:14px;line-height:25px"
        }, function (n, r) {
          t.mode(r.name);
          for (var i = t.mode(), o = 0, A = e.items.length; o < A; o++) {
            var a = e.items[o];
  ...
  e.exports = {
    ...
    render: function (e) {
      var t = this;
      return i.getSmallBtn.call(t, e, function (e) {
        return -1 !== e.queryCommandState("deletetable")
      }, function (e) {
        var t = UE.UETable.getUETableBySelected(e);
        t && a["default"].each(t.selectedTds || [], function (e) {
          e.style.borderTop.length > 0 ? (0, o.moveBorder)(t, e, "rowIndex", -1, {
            "border-bottom": null
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        var t = UE.UETable.getUETableBySelected(e);
        t && a["default"].each(t.selectedTds || [], function (e) {
          e.style.borderBottom.length > 0 ? c["default"].setStyleByAttr(e, "border-bottom", null) : c["default"].setStyleByAttr(e, "border-bottom", o.border)
        })
      }, !0)
    }
  }
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        if (t) {
          var n = void 0,
            ...
            i = void 0,
            A = void 0;
          for (i = t.cellsRange.beginRowIndex, A = t.cellsRange.endRowIndex; i <= A; i++)
            for (n = t.cellsRange.beginColIndex, r = t.cellsRange.endColIndex; n < r; n++) {
              var a = t.getCell(i, n);
              a && l["default"].setStyleByAttr(a, "border-right", o.border)
            }
          for (n = t.cellsRange.beginColIndex, r = t.cellsRange.endColIndex; n <= r; n++)
            for (i = t.cellsRange.beginRowIndex, A = t.cellsRange.endRowIndex; i < A; i++) {
              var c = t.getCell(i, n);
              c && l["default"].setStyleByAttr(c, "border-bottom", o.border)
            }
        }
      }, !0)
    }
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        if (t) {
          ...
          for (n = t.cellsRange.beginColIndex, r = t.cellsRange.endColIndex; n <= r; n++)
            for (i = t.cellsRange.beginRowIndex, A = t.cellsRange.endRowIndex; i < A; i++) {
              var a = t.getCell(i, n);
              a && l["default"].setStyleByAttr(a, "border-bottom", o.border)
            }
        }
      }, !0)
    }
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        var t = UE.UETable.getUETableBySelected(e);
        t && a["default"].each(t.selectedTds || [], function (e) {
          e.style.borderRight.length > 0 ? c["default"].setStyleByAttr(e, "border-right", null) : c["default"].setStyleByAttr(e, "border-right", o.border)
        })
      }, !0)
    }
  }
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        var t = UE.UETable.getUETableBySelected(e);
        if (t) {
          for (var n = t.cellsRange.beginColIndex, r = t.cellsRange.endColIndex; n <= r; n++) {
            var i = t.getCell(t.cellsRange.beginRowIndex, n);
            i && (0, o.moveBorder)(t, i, "rowIndex", -1, {
              "border-bottom": o.border
            })
          }
          for (var A = t.cellsRange.beginColIndex, a = t.cellsRange.endColIndex; A <= a; A++) {
            var c = t.getCell(t.cellsRange.endRowIndex, A);
            c && l["default"].setStyleByAttr(c, "border-bottom", o.border)
          }
          for (var d = t.cellsRange.beginRowIndex, u = t.cellsRange.endRowIndex; d <= u; d++) {
            var s = t.getCell(d, t.cellsRange.beginColIndex);
            s && (0, o.moveBorder)(t, s, "cellIndex", -1, {
              "border-right": o.border
            })
          }
          for (var f = t.cellsRange.beginRowIndex, p = t.cellsRange.endRowIndex; f <= p; f++) {
            var g = t.getCell(f, t.cellsRange.endColIndex);
            g && l["default"].setStyleByAttr(g, "border-right", o.border)
          }
        }
      }, !0)
    }
  ...
  e.exports = {
    ...
    render: function (e) {
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        var t = UE.UETable.getUETableBySelected(e);
        t && a["default"].each(t.selectedTds || [], function (e) {
          e.style.borderLeft.length > 0 ? (0, o.moveBorder)(t, e, "cellIndex", -1, {
            "border-right": null
    ...
    render: function (e) {
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        t && a["default"].each(t.selectedTds || [], function (e) {
          (0, o.moveBorder)(t, e, "cellIndex", -1, {
            "border-right": o.border
          }), c["default"].setStyleByAttr(e, "border-right", o.border), (0, o.moveBorder)(t, e, "rowIndex", -1, {
            "border-bottom": o.border
          }), c["default"].setStyleByAttr(e, "border-bottom", o.border)
        })
      }, !0)
    }
  }
    ...
    render: function (e) {
      ...
      return i.getSmallBtn.call(t, e, function (e) {
        ...
        t && a["default"].each(t.selectedTds || [], function (e) {
          (0, o.moveBorder)(t, e, "cellIndex", -1, {
            "border-right": "none"
          }), c["default"].setStyleByAttr(e, "border-right", "none"), (0, o.moveBorder)(t, e, "rowIndex", -1, {
            "border-bottom": "none"
          }), c["default"].setStyleByAttr(e, "border-bottom", "none")
        })
      }, !0)
    }
  }
  ...
  e.exports = {
    ...
    default_open_toolbar: "krcd-toolbar-editor",
    toolbars: [{
      ...
      items: [{
        ...
        items: [{
          ...
          render: function () {
            ...
            return e.innerHTML = '<div class="panel-content-ctrl" title="对象扩展" >\n            <div class="krcd-icon krcd-icon-openxml" style="width: 40px; height: 32px; float: none;"></div>\n            <div style="text-align: center;">对象扩展</div>\n          </div>', e = e.firstElementChild, e.addEventListener("click", function () {
              alert("对象扩展")
            }), e
          }
        }]
  ...
  var i = n(238),
    ...
    P = n(1),
    W = r(P),
    X = [o["default"], Q["default"], u["default"], b["default"], c["default"], f["default"], a["default"], g["default"], S["default"], h["default"], B["default"], x["default"], k["default"], E["default"], O["default"], L["default"]];
  e.exports = function () {
    window.UE !== undefined && W["default"].each(X, function (e) {
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "text/index.html", "文本框", "width:600px;height:480px;", [{
      ...
      var r = new baidu.editor.ui.Popup({
        ...
        _edit: function () {
          var n = r.anchorEl,
            i = e.__krcd__.getControlByEl(n);
          baidu.editor.plugins[t].krcdctrl = i, e.execCommand(t), this.hide()
        },
        _delete: function (e) {
          var t = this;
          a["default"].confirm.call(t.anchorEl, "是否删除？", function () {
            var e = t.anchorEl;
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("DESIGN" === this.__krcd__.mode()) {
          var n = c["default"].formatEvt(t),
            i = (n.evt, n.target);
          if (!c["default"].isBody(i) && !c["default"].isHtml(i)) {
            var o = c["default"].findParentCtrlNode(i);
            if (null !== o && (r.hide(), "text" === o.getAttribute("krcd-type"))) {
              var A = o.querySelector(".krcd-value"),
                a = A.getAttribute("title") || "文本框",
                l = r.formatHtml("<nobr> " + a + ': <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
              l ? (r.getDom("content").innerHTML = l, r.anchorEl = o, r.showAnchor(r.anchorEl)) : r.hide()
            }
          }
        }
      })
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "select/index.html", "下拉选项", "width:600px;height:600px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("DESIGN" === this.__krcd__.mode()) {
          ...
          if (!c["default"].isBody(i) && !c["default"].isHtml(i)) {
            var o = c["default"].findParentCtrlNode(i);
            if (null !== o && (r.hide(), "select" === o.getAttribute("krcd-type"))) {
              var A = o.querySelector(".krcd-value"),
                a = A.getAttribute("title") || "下拉选项",
                l = r.formatHtml("<nobr> " + a + ': <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
              l ? (r.getDom("content").innerHTML = l, r.anchorEl = o, r.showAnchor(r.anchorEl)) : r.hide()
            }
          }
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "checkbox/index.html", "复选框", "width:600px;height:600px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("DESIGN" === this.__krcd__.mode()) {
          ...
          if (!c["default"].isBody(i) && !c["default"].isHtml(i)) {
            var o = c["default"].findParentCtrlNode(i);
            if (null !== o && (r.hide(), "checkbox" === o.getAttribute("krcd-type"))) {
              var A = o.querySelector(".krcd-value"),
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "radio/index.html", "单选框", "width:600px;height:600px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("DESIGN" === this.__krcd__.mode()) {
          ...
          if (!c["default"].isBody(i) && !c["default"].isHtml(i)) {
            var o = c["default"].findParentCtrlNode(i);
            if (null !== o && (r.hide(), "radio" === o.getAttribute("krcd-type"))) {
              var A = o.querySelector(".krcd-value"),
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "label/index.html", "标签", "width:600px;height:350px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
          ...
          if ("editlabel" === r) n.render(), n.open();
            ...
            if ("removelabel" === r) {
              var A = o.cloneContents(),
                a = void 0;
              if (A) a = A.querySelectorAll('[krcd-type="label"]');
              else {
                var l = this.selection.getStart();
                "label" === l.getAttribute("krcd-type") && (a = [], a.push(l))
              }
              u["default"].each(a, function (e) {
                e.parentElement.replaceChild(document.createTextNode(e.innerText), e)
              })
              ...
              if (i) c["default"].remove(i, !1, !0);
                ...
                var d = o.cloneContents(),
                  s = void 0;
                if (d) s = d.querySelectorAll('[krcd-type="label"]');
                else {
                  var f = this.selection.getStart();
                  "label" === f.getAttribute("krcd-type") && (s = [], s.push(f))
                }
              ...
              var p = this.selection.getStart(),
                g = c["default"].findParent(p, function (e) {
                  return "label" === e.getAttribute("krcd-type")
                }, !0);
              if (g) return;
              var m = c["default"].findParent(p, function (e) {
                return "TD" === e.nodeName
              }, !0);
              if (m) return m.setAttribute("krcd-type", "label"), c["default"].addClass(m, "krcd-ctrl"), void c["default"].addClass(m, "krcd-label");
              var b = o.cloneContents();
              if (b) {
                var v = b.textContent,
                  h = c["default"].createElement(document, "label", {
                    "class": "krcd-ctrl krcd-label",
                    "krcd-type": "label"
                  });
                h.innerHTML = v, o.deleteContents(), o.insertNode(h)
              }
            }
          } else baidu.editor.plugins[t].krcdctrl = null, n.render(), n.open()
        }
      };
      var r = new baidu.editor.ui.Popup({
        editor: e,
        ...
        _edit: function () {
          var n = r.anchorEl,
            i = e.__krcd__.getControlByEl(n);
          baidu.editor.plugins[t].krcdctrl = i, e.execCommand(t, "editlabel"), this.hide()
        },
        _cancel: function () {
          var e = r.anchorEl;
          e.parentElement.replaceChild(document.createTextNode(e.innerText), e), this.hide()
        },
        _delete: function () {
          var e = this;
          a["default"].confirm.call(e.anchorEl, "是否删除？", function () {
            var t = e.anchorEl;
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("DESIGN" === this.__krcd__.mode()) {
          ...
          if (!c["default"].isBody(i) && !c["default"].isHtml(i)) {
            var o = c["default"].findParentCtrlNode(i);
            if (null !== o && (r.hide(), "label" === o.getAttribute("krcd-type"))) {
              var A = o.getAttribute("title") || "标签",
                a = r.formatHtml("<nobr> " + A + ': <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._cancel() title="移除控件但保留内容" class="edui-clickable">取消</span>&nbsp;&nbsp;<span onclick=$$._delete() title="移除控件不保留内容" class="edui-clickable">删除</span></nobr>');
              a ? (r.getDom("content").innerHTML = a, r.anchorEl = o, r.showAnchor(r.anchorEl)) : r.hide()
            }
          }
        }
      })
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "date/index.html", "日期控件", "width:800px;height:620px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("DESIGN" === this.__krcd__.mode()) {
          ...
          if (!c["default"].isBody(i) && !c["default"].isHtml(i)) {
            var o = c["default"].findParentCtrlNode(i);
            if (null !== o && (r.hide(), "date" === o.getAttribute("krcd-type"))) {
              var A = o.querySelector(".krcd-value"),
                a = A.getAttribute("title") || "日期控件",
                l = r.formatHtml("<nobr> " + a + ': <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
              l ? (r.getDom("content").innerHTML = l, r.anchorEl = o, r.showAnchor(r.anchorEl)) : r.hide()
            }
          }
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "section/index.html", "文档段", "width:600px;height:360px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("DESIGN" === this.__krcd__.mode()) {
          ...
          if (!c["default"].isBody(i) && !c["default"].isHtml(i)) {
            var o = c["default"].findParentCtrlNode(i);
            if (null !== o && (r.hide(), "section" === o.getAttribute("krcd-type"))) {
              var A = o.querySelector(".krcd-value"),
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = a["default"].getDialog(e, t, "kityformula/index.html", "公式", "width:783px; height: 386px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      var r = new baidu.editor.ui.Popup({
        ...
        _edit: function () {
          var n = r.anchorEl;
          baidu.editor.plugins[t].krcdctrl = n, e.execCommand(t), this.hide()
        },
        _delete: function () {
          var e = this;
          o["default"].confirm.call(this.anchorEl, "是否删除？", function () {
            var t = e.anchorEl;
            t.classList && t.classList.contains("krcd-kityformula") && (c["default"].remove(t, !1, !0), e.hide())
          }, function () {
            e.hide()
          })
        }
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("READONLY" !== this.__krcd__.mode()) {
          var n = c["default"].formatEvt(t),
            i = (n.evt, n.target);
          if (!c["default"].isBody(i) && !c["default"].isHtml(i) && "IMG" === i.nodeName && c["default"].hasClass(i, "krcd-kityformula")) {
            r.hide();
            var o = r.formatHtml('<nobr> 公式: <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
            o ? (r.getDom("content").innerHTML = o, r.anchorEl = i, r.showAnchor(r.anchorEl)) : r.hide()
          }
        }
      })
    }
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = i["default"].getUEDialog(e, t, "spechars/spechars.html", "字符", "", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
  ...
  var r = n(1),
    ...
    a = function (e) {
      return e ? e.replace("~/", this.options.UEDITOR_HOME_URL || "") : ""
    };
  e.exports = {
    name: "batchPlugins",
    plugin: function (e) {
      i["default"].each(A, function (t) {
        var n = new o(i["default"].extend({
        ...
        if (e.commands[t.cmd]) return void console.error("已存在[" + t.name + "]命令！");
        e.commands[t.cmd] = {
          execCommand: function () {
            n.render(), n.open()
          }
    ...
    plugin: function (e) {
      function t() {
        if (n && e.ui) {
          ...
          t && (n.style.top = t.offsetHeight + 3 + "px"), n.style.zIndex = Math.max(e.options.zIndex, e.iframe.style.zIndex) + 1
        }
      }
      var n, r = baidu.editor.ui,
        o = r.Message,
        A = [];
      e.setOpt("enableMessageShow", !0), !1 !== e.getOpt("enableMessageShow") && (e.addListener("ready", function () {
        n = document.getElementById(e.ui.id + "_message_holder"), t(), setTimeout(function () {
          t()
        }, 500)
    ...
    plugin: function (e) {
      ...
      e.commands.insertcontrol = {
        execCommand: function (n, r, o) {
          t || (t = this.__krcd__);
          var A = ["label"],
            a = r.getAttribute("krcd-type");
          if (a && A.indexOf(a) >= 0) return void e.execCommand("insertHtml", r.outerHTML);
          var l = t.createCtrl(r, o);
          l.refreshData(!0), e.execCommand("insertHtml", i["default"].specialStr + l.getCtrlElement().outerHTML + i["default"].specialStr)
        }
      }
    }
  }
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = a["default"].getDialog(e, "krcd" + t, "scrawl/index.html", "涂鸦", "width:750px;height:500px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      var r = new baidu.editor.ui.Popup({
        ...
        _delete: function () {
          ...
          o["default"].confirm.call(this.anchorEl, "是否删除？", function () {
            var t = e.anchorEl;
            t.classList && t.classList.contains("krcd-scrawl") && (c["default"].remove(t, !1, !0), e.hide())
          }, function () {
            e.hide()
          })
        }
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("READONLY" !== this.__krcd__.mode()) {
          var n = c["default"].formatEvt(t),
            i = (n.evt, n.target);
          if (!c["default"].isBody(i) && !c["default"].isHtml(i) && "IMG" === i.nodeName && c["default"].hasClass(i, "krcd-scrawl")) {
            r.hide();
            var o = r.formatHtml('<nobr> 涂鸦: <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
            o ? (r.getDom("content").innerHTML = o, r.anchorEl = i, r.showAnchor(r.anchorEl)) : r.hide()
          }
        }
      })
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = a["default"].getDialog(e, "krcd" + t, "vectordiagram/index.html", "矢量图", "width:750px;height:500px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
      ...
      var r = new baidu.editor.ui.Popup({
        ...
        _delete: function () {
          ...
          o["default"].confirm.call(this.anchorEl, "是否删除？", function () {
            var t = e.anchorEl;
            t.classList && t.classList.contains("krcd-vectordiagram") && (c["default"].remove(t, !1, !0), e.hide())
          }, function () {
            e.hide()
          })
        }
      ...
      r.render(), e.addListener("mouseover", function (e, t) {
        if ("READONLY" !== this.__krcd__.mode()) {
          var n = c["default"].formatEvt(t),
            i = (n.evt, n.target);
          if (!c["default"].isBody(i) && !c["default"].isHtml(i) && "IMG" === i.nodeName && c["default"].hasClass(i, "krcd-vectordiagram")) {
            r.hide();
            var o = r.formatHtml('<nobr> 矢量图: <span onclick=$$._edit() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
            o ? (r.getDom("content").innerHTML = o, r.anchorEl = i, r.showAnchor(r.anchorEl)) : r.hide()
          }
        }
      })
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = i["default"].getDialog(e, "krcd" + t, t + "/index.html", "字数统计", "width:250px;height:150px;", [{
          className: "edui-okbutton",
          label: "关闭",
          onclick: function () {
            n.close(!0)
  ...
  e.exports = {
    ...
    plugin: function (e) {
      var t = this.name,
        n = o["default"].getDialog(e, t, "template/index.html", "控件库", "width:600px;height:480px;", [{
          className: "edui-okbutton",
          label: "确定",
          onclick: function () {
            n.close(!0)
  ...
  t = e.exports = n(22)(!1), t.push([e.i, ".krcd-editor {\r\n  position: relative;\r\n  width: 100%;\r\n  height: 100%;\r\n  overflow-x: hidden;\r\n}\r\n\r\n.krcd-editor-outer {\r\n  margin: 0 auto;\r\n  height: auto;\r\n  background-color: white;\r\n  border: 1px solid #d4d4d4;\r\n  box-shadow: 0 0 0 1px #d1d1d1, 0 0 3px 1px #ccc;\r\n}\r\n\r\n.krcd-editor-page_header_footer {\r\n  display: none;\r\n  position: relative;\r\n  z-index: 1000;\r\n  height: 100%;\r\n  width: 100%;\r\n  top: 0;\r\n  left: 0;\r\n}\r\n\r\n.krcd-editor-page_header_footer .bg {\r\n  height: 100%;\r\n  width: 100%;\r\n  background-color: #000;\r\n  opacity: 0.3;\r\n  filter: alpha(opacity=30);\r\n}\r\n\r\n.krcd-editor-page_header_footer .header {\r\n  z-index: 1001;\r\n  min-height: 30px;\r\n  top: 0;\r\n  position: absolute;\r\n  background: white;\r\n  width: 100%;\r\n  overflow-x: hidden;\r\n}\r\n\r\n.krcd-editor-page_header_footer .header .content,\r\n.krcd-editor-page_header_footer .footer .content {\r\n  margin: 10px auto;\r\n}\r\n\r\n.krcd-editor-page_header_footer .footer {\r\n  z-index: 1001;\r\n  min-height: 30px;\r\n  bottom: 0;\r\n  position: absolute;\r\n  background: white;\r\n  width: 100%;\r\n  overflow-x: hidden;\r\n}\r\n\r\n.krcd-editor-pager {\r\n  z-index: 10;\r\n  position: absolute;\r\n  top: 40px;\r\n  font-size: 12px;\r\n}\r\n\r\n.krcd-editor-pager .krcd-editor-pager-page {\r\n  border-top: 2px dotted #d4d4d4;\r\n  position: relative;\r\n}\r\n\r\n.krcd-editor-pager .krcd-editor-pager-page .krcd-page-header {\r\n  border-bottom-right-radius: 4px;\r\n  border-top-right-radius: 4px;\r\n  background-color: white;\r\n  top: 20px;\r\n  right: -37px;\r\n  padding: 0 5px;\r\n  line-height: 25px;\r\n  border-top: 1px solid #d4d4d4;\r\n  border-right: 1px solid #d4d4d4;\r\n  border-bottom: 1px solid #d4d4d4;\r\n  position: absolute;\r\n  cursor: pointer;\r\n}\r\n\r\n.krcd-editor-pager .krcd-editor-pager-page .krcd-page-footer {\r\n  border-bottom-right-radius: 4px;\r\n  border-top-right-radius: 4px;\r\n  background-color: white;\r\n  bottom: 20px;\r\n  right: -37px;\r\n  padding: 0 5px;\r\n  line-height: 25px;\r\n  border-top: 1px solid #d4d4d4;\r\n  border-right: 1px solid #d4d4d4;\r\n  border-bottom: 1px solid #d4d4d4;\r\n  position: absolute;\r\n  cursor: pointer;\r\n}\r\n\r\n.krcd-editor-pager .krcd-editor-pager-page .krcd-page-num {\r\n  position: absolute;\r\n  bottom: 5px;\r\n  color: #767676;\r\n  padding-left: 8px;\r\n  padding-right: 8px;\r\n  white-space: nowrap;\r\n  cursor: default;\r\n  right: -25px;\r\n}\r\n\r\n.krcd-editor-footer {\r\n  text-align: center;\r\n  font-size: 12px;\r\n  color: #999;\r\n  margin-bottom: 20px;\r\n}\r\n\r\n.krcd-editor-inner .edui-editor {\r\n  border: none !important;\r\n}", ""])
}, function (e, t, n) {
  var r, i;
  ! function (o, A) {
    "use strict";
    ...
    t = function (e) {
      return "object" == typeof e && (E ? k(e) : "[object RegExp]" === C.call(e))
    };
    var I, S = String.prototype.valueOf,
      D = function (e) {
        try {
          return S.call(e), !0
        } catch (t) {
    ...
    I = function (e) {
      return "string" == typeof e || "object" == typeof e && (E ? D(e) : "[object String]" === C.call(e))
    };
    var O = i.defineProperty && function () {
      ...
      W = {
        ToInteger: function (e) {
          var t = +e;
          return P(t) ? t = 0 : 0 !== t && t !== 1 / 0 && t !== -1 / 0 && (t = (t > 0 || -1) * Math.floor(Math.abs(t))), t
        },
    ...
    Y(a, {
      bind: function (t) {
        ...
        for (var r, o = s.call(arguments, 1), a = function () {
            if (this instanceof r) {
              var e = h.call(n, this, m.call(o, s.call(arguments)));
              return i(e) === e ? e : this
            }
            return h.call(n, t, m.call(o, s.call(arguments)))
          }, l = w(0, n.length - o.length), c = [], d = 0; d < l; d++) p.call(c, "$" + d);
        return r = A("binder", "return function (" + b.call(c, ",") + "){ return binder.apply(this, arguments); }")(a), n.prototype && (X.prototype = n.prototype, r.prototype = new X, X.prototype = null), r
      }
    });
    ...
    Y(r, {
      ...
      map: function (t) {
        ...
        for (var l = 0; l < A; l++) l in o && (a[l] = void 0 === r ? t(o[l], l, i) : t.call(r, o[l], l, i));
        return a
      }
    }, !ne(r.map)), Y(r, {
      filter: function (t) {
        ...
        for (var l = 0; l < A; l++) l in o && (n = o[l], (void 0 === r ? t(n, l, i) : t.call(r, n, l, i)) && q(a, n));
        return a
      }
    }, !ne(r.filter)), Y(r, {
      every: function (t) {
        ...
        for (var A = 0; A < o; A++)
          if (A in i && !(void 0 === n ? t(i[A], A, r) : t.call(n, i[A], A, r))) return !1;
        return !0
      }
    }, !ne(r.every)), Y(r, {
      some: function (t) {
        ...
        for (var A = 0; A < o; A++)
          if (A in i && (void 0 === n ? t(i[A], A, r) : t.call(n, i[A], A, r))) return !0;
        return !1
      }
    }, !ne(r.some));
    var re = !1;
    r.reduce && (re = "object" == typeof r.reduce.call("es5", function (e, t, n, r) {
      return r
    })), Y(r, {
      reduce: function (t) {
    ...
    Y(r, {
      indexOf: function (e) {
        ...
        if (0 === n) return -1;
        var r = 0;
        for (arguments.length > 1 && (r = W.ToInteger(arguments[1])), r = r >= 0 ? r : w(0, n + r); r < n; r++)
    ...
    Y(r, {
      lastIndexOf: function (e) {
        ...
        if (0 === n) return -1;
        var r = n - 1;
        for (arguments.length > 1 && (r = B(r, W.ToInteger(arguments[1]))), r = r >= 0 ? r : n - Math.abs(r); r >= 0; r--)
    ...
    Y(r, {
      splice: function (e, t) {
        ...
        var n = arguments;
        return this.length = w(W.ToInteger(this.length), 0), arguments.length > 0 && "number" != typeof t && (n = F(arguments), n.length < 2 ? q(n, this.length - e) : n[1] = W.ToInteger(t)), f.apply(this, n)
      }
    }, !le);
    var ce = function () {
        var e = new n(1e5);
    ...
    Y(r, {
      splice: function (e, t) {
        for (var n, r = W.ToObject(this), i = [], o = W.ToUint32(r.length), A = W.ToInteger(e), a = A < 0 ? w(o + A, 0) : B(A, o), c = B(w(W.ToInteger(t), 0), o - a), d = 0; d < c;) n = l(a + d), V(r, n) && (i[d] = r[n]), d += 1;
        var u, s = F(arguments, 2),
          f = s.length;
        if (f < c) {
          d = a;
          for (var p = o - c; d < p;) n = l(d + c), u = l(d + f), V(r, n) ? r[u] = r[n] : delete r[u], d += 1;
          d = o;
          for (var g = o - c + f; d > g;) delete r[d - 1], d -= 1
        } else if (f > c)
          for (d = o - c; d > a;) n = l(d + c - 1), u = l(d + f - 1), V(r, n) ? r[u] = r[n] : delete r[u], d -= 1;
        d = a;
        for (var m = 0; m < s.length; ++m) r[d] = s[m], d += 1;
    ...
    var pe = function (e) {
      ...
      ge = function () {
        var e = {};
        return 1 !== Array.prototype.push.call(e, undefined) || 1 !== e.length || "undefined" != typeof e[0] || !V(e, 0)
      }();
    Y(r, {
      push: function (e) {
        return z(this) ? p.apply(this, arguments) : pe.apply(this, arguments)
      }
    }, ge);
    var me = function () {
      var e = [];
      return 1 !== e.push(undefined) || 1 !== e.length || "undefined" != typeof e[0] || !V(e, 0)
    }();
    Y(r, {
      push: pe
    }, me), Y(r, {
    ...
    var we = !J({
      ...
      xe = function () {
        ...
        for (var e in window) try {
          !ye["$" + e] && V(window, e) && null !== window[e] && "object" == typeof window[e] && Ee(window[e])
        } catch (Qt) {
          return !0
        }
        return !1
      ...
      Qe = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"],
      Ue = Qe.length,
      ke = function (e) {
    ...
    Y(i, {
      keys: function (t) {
        ...
        if (!r)
          for (var d in t) a && "prototype" === d || !V(t, d) || q(A, l(d));
        if (we)
    ...
    var Le, Pe, We = 0 !== new Date(-0xc782b5b342b24).getUTCMonth(),
      Xe = new Date(-0x55d318d56a724),
      Ve = new Date(14496624e5),
      je = "Mon, 01 Jan -45875 11:59:59 GMT" !== Xe.toUTCString();
    Xe.getTimezoneOffset() < -720 ? (Le = "Tue Jan 02 -45875" !== Xe.toDateString(), Pe = !/^Thu Dec 10 2015 \d\d:\d\d:\d\d GMT[-+]\d\d\d\d(?: |$)/.test(String(Ve))) : (Le = "Mon Jan 01 -45875" !== Xe.toDateString(), Pe = !/^Wed Dec 09 2015 \d\d:\d\d:\d\d GMT[-+]\d\d\d\d(?: |$)/.test(String(Ve)));
    ...
    Y(Date.prototype, {
      ...
      toUTCString: function () {
        ...
        var e = Ze(this),
          ...
          o = Je(this),
          A = Ke(this);
        return _e[e] + ", " + (t < 10 ? "0" + t : t) + " " + $e[n] + " " + r + " " + (i < 10 ? "0" + i : i) + ":" + (o < 10 ? "0" + o : o) + ":" + (A < 10 ? "0" + A : A) + " GMT"
      }
    }, We || je), Y(Date.prototype, {
      toDateString: function () {
        ...
        var e = this.getDay(),
          ...
          n = this.getMonth(),
          r = this.getFullYear();
        return _e[e] + " " + $e[n] + " " + (t < 10 ? "0" + t : t) + " " + r
      }
    }, We || Le), (We || Pe) && (Date.prototype.toString = function () {
      if (!(this && this instanceof Date)) throw new TypeError("this is not a Date object.");
      var e = this.getDay(),
        t = this.getDate(),
        n = this.getMonth(),
      ...
      return _e[e] + " " + $e[n] + " " + (t < 10 ? "0" + t : t) + " " + r + " " + (i < 10 ? "0" + i : i) + ":" + (o < 10 ? "0" + o : o) + ":" + (A < 10 ? "0" + A : A) + " GMT" + (a > 0 ? "-" : "+") + (l < 10 ? "0" + l : l) + (c < 10 ? "0" + c : c)
    }, O && i.defineProperty(Date.prototype, "toString", {
      configurable: !0,
      enumerable: !1,
      writable: !0
    }));
    var tt = Date.prototype.toISOString && -1 === new Date(-621987552e5).toISOString().indexOf("-000001"),
      nt = Date.prototype.toISOString && "1969-12-31T23:59:59.999Z" !== new Date(-1).toISOString(),
    ...
    Y(Date.prototype, {
        toISOString: function () {
          ...
          e = (e < 0 ? "-" : e > 9999 ? "+" : "") + N("00000" + Math.abs(e), 0 <= e && e <= 9999 ? -4 : -6);
          for (var r = 0; r < n.length; ++r) n[r] = N("00" + n[r], -2);
          return e + "-" + F(n, 0, 2).join("-") + "T" + F(n, 2).join(":") + "." + N("000" + ze(this), -3) + "Z"
        }
      }, tt || nt),
      function () {
        try {
    ...
    var it = 1e15 === Date.parse("+033658-09-27T01:46:40.000Z"),
      ot = !isNaN(Date.parse("2012-04-04T24:00:00.500Z")) || !isNaN(Date.parse("2012-11-31T23:59:59.000Z")) || !isNaN(Date.parse("2012-12-31T23:59:60.000Z"));
      ...
      Date = function (e) {
        var t = function (n, r, i, o, A, a, c) {
            ...
            if (this instanceof e) {
              ...
              d = 1 === u && l(n) === n ? new e(t.parse(n)) : u >= 7 ? new e(n, r, i, o, A, s, f) : u >= 6 ? new e(n, r, i, o, A, s) : u >= 5 ? new e(n, r, i, o, A) : u >= 4 ? new e(n, r, i, o) : u >= 3 ? new e(n, r, i) : u >= 2 ? new e(n, r) : u >= 1 ? new e(n instanceof e ? +n : n) : new e
        ...
        return Y(t, {
          now: e.now,
          UTC: e.UTC
        }, !0), t.prototype = e.prototype, Y(t.prototype, {
          constructor: t
        }, !0), Y(t, {
          parse: function (t) {
            var r = n.exec(t);
            if (r) {
              var A, a = d(r[1]),
                ...
                b = d(r[10] || 0),
                v = d(r[11] || 0);
              return u < (s > 0 || f > 0 || p > 0 ? 24 : 25) && s < 60 && f < 60 && p < 1e3 && l > -1 && l < 12 && b < 24 && v < 60 && c > -1 && c < i(a, l + 1) - i(a, l) && (A = 60 * (24 * (i(a, l) + c) + u + b * m), A = 1e3 * (60 * (A + s + v * m) + f) + p, g && (A = o(A)), -864e13 <= A && A <= 864e13) ? A : NaN
            }
    ...
    var lt = u.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)),
      ct = {
        base: 1e7,
        size: 6,
        data: [0, 0, 0, 0, 0, 0],
        multiply: function (e, t) {
          for (var n = -1, r = t; ++n < ct.size;) r += e * ct.data[n], ct.data[n] = r % ct.base, r = Math.floor(r / ct.base)
        },
        divide: function (e) {
          for (var t = ct.size, n = 0; --t >= 0;) n += ct.data[t], ct.data[t] = Math.floor(n / e), n = n % e * ct.base
        },
        numToString: function () {
          for (var e = ct.size, t = ""; --e >= 0;)
            if ("" !== t || 0 === e || 0 !== ct.data[e]) {
              var n = l(ct.data[e]);
              "" === t ? t = n : t += N("0000000", 0, 7 - n.length) + n
            } return t
        },
    ...
    Y(u, {
      toFixed: function (e) {
        var t, n, r, i, o, A, a, c;
        if (t = d(e), (t = P(t) ? 0 : Math.floor(t)) < 0 || t > 20) throw new RangeError("Number.toFixed called with invalid number of decimals");
        if (n = d(this), P(n)) return "NaN";
        if (n <= -1e21 || n >= 1e21) return l(n);
        if (r = "", n < 0 && (r = "-", n = -n), i = "0", n > 1e-21)
          if (o = ct.log(n * ct.pow(2, 69, 1)) - 69, A = o < 0 ? n * ct.pow(2, -o, 1) : n / ct.pow(2, o, 1), A *= 4503599627370496, (o = 52 - o) > 0) {
            for (ct.multiply(0, A), a = t; a >= 7;) ct.multiply(1e7, 0), a -= 7;
            for (ct.multiply(ct.pow(10, a, 1), 0), a = o - 1; a >= 23;) ct.divide(1 << 23), a -= 23;
            ct.divide(1 << a), ct.multiply(1, 1), ct.divide(2), i = ct.numToString()
          } else ct.multiply(0, A), ct.multiply(1 << -o, 0), i = ct.numToString() + N("0.00000000000000000000", 2, 2 + t);
        return t > 0 ? (c = i.length, i = c <= t ? r + N("0.0000000000000000000", 0, t - c + 2) + i : r + N(i, 0, c - t) + "." + N(i, c - t)) : i = r + i, i
      }
    }, lt);
    var dt = function () {
        try {
    ...
    Y(u, {
    ...
    }, dt), 2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? function () {
      ...
      c.split = function (r, i) {
        ...
        for (a = f.exec(o); a && !((l = a.index + a[0].length) > s && (q(d, N(o, s, a.index)), !e && a.length > 1 && a[0].replace(A, function () {
            for (var e = 1; e < arguments.length - 2; e++) "undefined" == typeof arguments[e] && (a[e] = void 0)
          }), a.length > 1 && a.index < o.length && p.apply(d, F(a, 1)), c = a[0].length, s = l, d.length >= g));) f.lastIndex === a.index && f.lastIndex++, a = f.exec(o);
        return s === o.length ? !c && f.test("") || q(d, "") : q(d, N(o, s)), d.length > g ? F(d, 0, g) : d
      }
    ...
    (function () {
      ...
      if (i && o) {
        var A = function (e) {
          ...
          n.lastIndex = 0;
          var o = n.exec(e) || [];
          return n.lastIndex = i, q(o, arguments[t - 2], arguments[t - 1]), r.apply(this, o)
        };
    ...
    Y(c, {
      substr: function (e, t) {
        var n = e;
        return e < 0 && (n = w(this.length + e, 0)), ft.call(this, n, t)
      }
    }, pt);
    var gt = "\t\n\x0B\f\r   ᠎             　\u2028\u2029\ufeff",
      mt = "​",
    ...
    Y(c, {
      trim: function () {
        ...
        return l(this).replace(vt, "").replace(ht, "")
      }
    }, wt);
    ...
    Y(c, {
      lastIndexOf: function (e) {
        if (void 0 === this || null === this) throw new TypeError("can't convert " + this + " to object");
        for (var t = l(this), n = l(e), r = arguments.length > 1 ? d(arguments[1]) : NaN, i = P(r) ? Infinity : W.ToInteger(r), o = B(w(i, 0), t.length), A = n.length, a = o + A; a > 0;) {
          a = w(0, a - A);
          var c = Z(N(t, a, o + A), n);
          if (-1 !== c) return a + c
        }
    ...
    if (Y(c, {
      ...
      }, 1 !== c.lastIndexOf.length), 8 === parseInt(gt + "08") && 22 === parseInt(gt + "0x16") || (parseInt = function (e) {
        var t = /^[-+]?0[xX]/;
        return function (n, r) {
          var i = Bt(String(n)),
    ...
    if (O) {
      ...
      xt(Error.prototype, "message"), "" !== Error.prototype.message && (Error.prototype.message = ""), xt(Error.prototype, "name")
    }
  ...
  ! function (o, A) {
    ...
    var e, t, n, r, i = Function.call,
      o = Object.prototype,
      A = i.bind(o.hasOwnProperty),
      a = i.bind(o.propertyIsEnumerable),
      l = i.bind(o.toString),
      c = A(o, "__defineGetter__");
    c && (e = i.bind(o.__defineGetter__), t = i.bind(o.__defineSetter__), n = i.bind(o.__lookupGetter__), r = i.bind(o.__lookupSetter__));
    var d = function (e) {
      return null == e || "object" != typeof e && "function" != typeof e
    };
    Object.getPrototypeOf || (Object.getPrototypeOf = function (e) {
      var t = e.__proto__;
      return t || null === t ? t : "[object Function]" === l(e.constructor) ? e.constructor.prototype : e instanceof Object ? o : null
    });
    var u = function (e) {
      try {
    ...
    if (Object.defineProperty) {
      var s = u({});
      if (!("undefined" == typeof document || u(document.createElement("div"))) || !s) var f = Object.getOwnPropertyDescriptor
    }
    if (!Object.getOwnPropertyDescriptor || f) {
      Object.getOwnPropertyDescriptor = function (e, t) {
        if (d(e)) throw new TypeError("Object.getOwnPropertyDescriptor called on a non-object: " + e);
        if (f) try {
        ...
        if (i = {
          ...
          var s = n(e, t),
            p = r(e, t);
          if (u && (e.__proto__ = l), s || p) return s && (i.get = s), p && (i.set = p), i
        }
    ...
    if (Object.getOwnPropertyNames || (Object.getOwnPropertyNames = function (e) {
      ...
      p = g || "undefined" == typeof document ? function () {
        ...
        var t = function () {};
        return t.prototype = e, p = function () {
          return new t
        }, new t
        ...
        if (null === e) n = p();
          ...
          if (null !== e && d(e)) throw new TypeError("Object prototype may only be an Object or null");
    ...
    if (Object.defineProperty) {
      var w = h({}),
        B = "undefined" == typeof document || h(document.createElement("div"));
      if (!w || !B) var C = Object.defineProperty,
        E = Object.defineProperties
    }
    if (!Object.defineProperty || C) {
      Object.defineProperty = function (i, A, a) {
        if (d(i)) throw new TypeError("Object.defineProperty called on non-object: " + i);
        if (d(a)) throw new TypeError("Property description must be an object: " + a);
        if (C) try {
        ...
        if ("value" in a)
          if (c && (n(i, A) || r(i, A))) {
            var l = i.__proto__;
            i.__proto__ = o, delete i[A], i[A] = a.value, i.__proto__ = l
          } else i[A] = a.value;
        else {
          var u = "get" in a,
            s = "set" in a;
          if (!c && (u || s)) throw new TypeError("getters & setters can not be defined on this javascript engine");
