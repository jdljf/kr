...
(function() {
  ...
  if (URL.endsWith('static/js/')) {
    URL = URL.replace('static/js/', 'static/krcdEditor/');
  } else {
    URL = URL + 'static/krcdEditor/';
  }
  /*
  KRCD_CONFIG 配置项
  */
  ...
  window.KRCD_CONFIG = {
    ...
    EDITOR_URL: URL + 'js/krcd-ie8-editor.js',
    IE8_SCRIPT: [
  ...
  window.UEDITOR_CONFIG = {
    ...
    // iframeJsUrl: URL + window.KRCD_CONFIG.EDITOR_URL + '?temp=' + new Date().getTime(), //给编辑区域的iframe引入一个js文件
